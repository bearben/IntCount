...
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000110 X3) (bvmul #b111111111100 X4) (bvmul #b111111110110 X7) (bvmul #b111111110110 X8)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111110111 X3) (bvmul #b000000001010 X9)  #b111111110111) #b000000000000))
