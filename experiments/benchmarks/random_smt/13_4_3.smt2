...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111001 X1) (bvmul #b111111111000 X3)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X11) (bvmul #b000000001000 X12)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X3)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X4) (bvmul #b111111111011 X7) (bvmul #b000000001001 X10)  #b000000000111) #b000000000000))
