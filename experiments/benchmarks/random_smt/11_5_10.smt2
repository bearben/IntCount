...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111110111 X1) (bvmul #b000000001010 X2) (bvmul #b111111110111 X3) (bvmul #b111111111100 X5) (bvmul #b111111111101 X6) (bvmul #b000000000110 X7) (bvmul #b111111110110 X8) (bvmul #b111111111011 X9) (bvmul #b111111111111 X10)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b111111110110 X1) (bvmul #b111111110111 X2) (bvmul #b000000000011 X4) (bvmul #b000000000100 X6)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X7)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X2)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X9) (bvmul #b111111110110 X10)  #b111111111010) #b000000000000))
