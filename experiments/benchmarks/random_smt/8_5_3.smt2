...
(assert (bvsge (bvadd (bvmul #b111111110111 X5) (bvmul #b000000001001 X6) (bvmul #b000000001000 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b000000000010 X5)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X6)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X2) (bvmul #b111111111010 X6)  #b111111111001) #b000000000000))
