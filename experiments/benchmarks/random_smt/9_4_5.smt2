...
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b000000001001 X2) (bvmul #b111111111010 X4) (bvmul #b000000000111 X7) (bvmul #b000000000001 X8)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111111111 X1) (bvmul #b111111111000 X2) (bvmul #b000000001010 X4) (bvmul #b000000001000 X8)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X2) (bvmul #b000000000111 X3) (bvmul #b111111110110 X7)  #b000000000111) #b000000000000))
