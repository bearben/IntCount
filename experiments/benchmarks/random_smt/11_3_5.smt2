...
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b111111111110 X2) (bvmul #b111111110111 X3) (bvmul #b000000001000 X5) (bvmul #b111111111000 X8)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X3) (bvmul #b000000000101 X10)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b111111111110 X9) (bvmul #b111111111111 X10)  #b111111110110) #b000000000000))
