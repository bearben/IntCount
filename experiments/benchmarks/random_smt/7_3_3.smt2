...
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b000000000100 X2) (bvmul #b111111111101 X4)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X4) (bvmul #b000000000001 X5)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111111 X3) (bvmul #b000000001001 X6)  #b000000000111) #b000000000000))
