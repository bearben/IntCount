...
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b000000000111 X1) (bvmul #b000000001010 X3)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b000000000001 X1) (bvmul #b111111111010 X3)  #b111111111111) #b000000000000))
