...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000011 X2) (bvmul #b000000000111 X3) (bvmul #b000000000101 X5)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1) (bvmul #b111111111100 X4)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X4) (bvmul #b111111111001 X5) (bvmul #b000000000101 X6) (bvmul #b000000000011 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111110110 X3) (bvmul #b000000000100 X4) (bvmul #b111111111101 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111001 X6)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b000000001001 X4) (bvmul #b111111111000 X5) (bvmul #b000000000001 X6)  #b000000000100) #b000000000000))
