...
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b111111111000 X1) (bvmul #b000000000111 X2) (bvmul #b000000000101 X3) (bvmul #b111111111000 X4) (bvmul #b000000000001 X5)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b000000001000 X2)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000000100 X2) (bvmul #b000000000010 X3) (bvmul #b000000000101 X4)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b111111110110 X5)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b000000001010 X1) (bvmul #b000000000110 X3) (bvmul #b000000000010 X4)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2) (bvmul #b111111111111 X3) (bvmul #b111111110111 X5)  #b111111110110) #b000000000000))
