...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b000000001010 X1) (bvmul #b111111111100 X2) (bvmul #b111111110111 X3) (bvmul #b000000001000 X4) (bvmul #b111111110110 X5) (bvmul #b111111111111 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000001010 X1) (bvmul #b111111111001 X2) (bvmul #b111111111100 X5) (bvmul #b000000001001 X6) (bvmul #b111111111100 X7)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000011 X2) (bvmul #b000000001001 X3) (bvmul #b000000000100 X4) (bvmul #b111111111110 X5) (bvmul #b111111111010 X6) (bvmul #b000000001001 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111110110 X1) (bvmul #b000000000111 X2) (bvmul #b111111111010 X5) (bvmul #b111111111100 X6)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111100 X3) (bvmul #b000000001000 X7)  #b000000000010) #b000000000000))
