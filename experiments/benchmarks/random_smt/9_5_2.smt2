...
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111011 X3)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X3) (bvmul #b000000000011 X8)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1)  #b111111111100) #b000000000000))
