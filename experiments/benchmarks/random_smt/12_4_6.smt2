...
(assert (bvsge (bvadd (bvmul #b000000001010 X4) (bvmul #b000000000010 X5) (bvmul #b111111110110 X6) (bvmul #b000000000101 X8) (bvmul #b000000001001 X9) (bvmul #b000000000111 X10)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X1) (bvmul #b000000000001 X3) (bvmul #b111111111010 X8) (bvmul #b000000001000 X9)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X9)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X2) (bvmul #b000000000011 X3) (bvmul #b111111111110 X4)  #b000000000111) #b000000000000))
