...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000000100 X1) (bvmul #b000000000011 X2) (bvmul #b000000001001 X4) (bvmul #b000000001001 X5)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1) (bvmul #b000000001000 X2) (bvmul #b111111111100 X4) (bvmul #b000000000011 X5)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1) (bvmul #b111111111010 X2) (bvmul #b111111111010 X5)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111111100 X1) (bvmul #b000000000010 X2) (bvmul #b111111111010 X4) (bvmul #b111111111000 X5)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X2)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000000101 X3) (bvmul #b111111111101 X4)  #b111111111101) #b000000000000))
