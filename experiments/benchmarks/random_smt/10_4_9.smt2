...
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111100 X1) (bvmul #b111111111100 X2) (bvmul #b000000000111 X3) (bvmul #b111111111010 X4) (bvmul #b000000000010 X5) (bvmul #b111111111010 X6) (bvmul #b000000000110 X8) (bvmul #b111111111000 X9)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111101 X3) (bvmul #b000000001000 X4) (bvmul #b111111110111 X9)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111110 X1) (bvmul #b111111111101 X2) (bvmul #b000000000010 X3) (bvmul #b000000001010 X4) (bvmul #b000000000011 X6) (bvmul #b000000001000 X7) (bvmul #b111111111111 X8) (bvmul #b000000001010 X9)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X7)  #b000000001000) #b000000000000))
