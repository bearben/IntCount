...
(assert (bvsge (bvadd (bvmul #b000000000010 X3) (bvmul #b111111111011 X4) (bvmul #b000000000110 X6) (bvmul #b000000001001 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X1) (bvmul #b000000001001 X2)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111110111 X4) (bvmul #b111111111100 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b111111111110 X5)  #b000000000110) #b000000000000))
