...
(assert (bvsge (bvadd (bvmul #b000000000010 X5) (bvmul #b111111111111 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X8)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X8)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X2) (bvmul #b111111111010 X12)  #b111111111001) #b000000000000))
