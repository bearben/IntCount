...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000111 X1) (bvmul #b000000000111 X2) (bvmul #b111111111011 X3) (bvmul #b000000000101 X4) (bvmul #b111111111110 X5) (bvmul #b000000000111 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000010 X1) (bvmul #b000000000110 X2) (bvmul #b000000000101 X3) (bvmul #b111111111110 X5) (bvmul #b111111111100 X6) (bvmul #b111111110111 X7)  #b111111110111) #b000000000000))
