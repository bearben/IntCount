...
(assert (bvsge (bvadd (bvmul #b000000000011 X0)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X8)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X3)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X2)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X9)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X4)  #b111111110110) #b000000000000))
