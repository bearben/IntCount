...
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b111111111101 X6) (bvmul #b111111110111 X8)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X2) (bvmul #b000000000111 X3) (bvmul #b000000001010 X5)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X5) (bvmul #b111111111000 X8)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X4) (bvmul #b111111111010 X5)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X4) (bvmul #b000000000110 X8)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111010 X6)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X6)  #b000000001000) #b000000000000))
