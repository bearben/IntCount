...
(assert (bvsge (bvadd (bvmul #b000000001000 X1) (bvmul #b111111110110 X3) (bvmul #b111111111101 X8)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X2) (bvmul #b000000001010 X9)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X2)  #b111111111100) #b000000000000))
