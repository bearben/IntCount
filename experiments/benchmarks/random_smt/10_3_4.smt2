...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111111 X2) (bvmul #b000000001000 X5) (bvmul #b000000000011 X7)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111100 X3) (bvmul #b111111111111 X4) (bvmul #b000000000111 X6)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111111 X7)  #b000000000011) #b000000000000))
