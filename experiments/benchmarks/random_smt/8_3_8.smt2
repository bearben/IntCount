...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b111111111011 X1) (bvmul #b111111111100 X2) (bvmul #b111111111001 X3) (bvmul #b111111111100 X4) (bvmul #b111111111100 X5) (bvmul #b111111111001 X6) (bvmul #b111111110111 X7)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X3) (bvmul #b111111111111 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b111111111010 X1) (bvmul #b000000000101 X2) (bvmul #b000000000011 X3) (bvmul #b111111111101 X4) (bvmul #b111111110110 X5) (bvmul #b000000000111 X7)  #b111111111011) #b000000000000))
