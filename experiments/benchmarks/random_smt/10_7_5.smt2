...
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111000 X3) (bvmul #b111111111111 X6) (bvmul #b000000000111 X8) (bvmul #b111111111101 X9)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X2) (bvmul #b111111111010 X4) (bvmul #b000000000110 X5) (bvmul #b111111110111 X9)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111111010 X3) (bvmul #b000000001001 X4) (bvmul #b111111111100 X8) (bvmul #b111111110110 X9)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X6) (bvmul #b111111111000 X7) (bvmul #b111111111101 X8)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X3) (bvmul #b000000001010 X5) (bvmul #b000000000111 X9)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b000000000100 X4) (bvmul #b000000000101 X8)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X8)  #b000000001010) #b000000000000))
