...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111110 X1) (bvmul #b111111111100 X5)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X3)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b000000000110 X4) (bvmul #b111111111111 X5)  #b000000000010) #b000000000000))
