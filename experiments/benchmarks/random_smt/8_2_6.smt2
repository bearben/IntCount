...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111110111 X1) (bvmul #b000000001001 X2) (bvmul #b111111110111 X3) (bvmul #b111111111011 X6) (bvmul #b000000000111 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111100 X3) (bvmul #b000000000101 X4) (bvmul #b111111111110 X5) (bvmul #b000000001000 X6)  #b000000000001) #b000000000000))
