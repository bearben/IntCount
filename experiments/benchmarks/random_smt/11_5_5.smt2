...
(assert (bvsge (bvadd (bvmul #b111111111001 X2) (bvmul #b000000001000 X5) (bvmul #b000000000111 X7) (bvmul #b111111111110 X8) (bvmul #b111111111010 X9)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111111010 X3) (bvmul #b111111111101 X4) (bvmul #b111111111000 X7) (bvmul #b111111111001 X8)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X3) (bvmul #b000000000111 X7) (bvmul #b111111111110 X8) (bvmul #b000000001000 X9) (bvmul #b111111111100 X10)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X6)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X2) (bvmul #b000000000001 X5) (bvmul #b111111111110 X7) (bvmul #b111111111101 X8) (bvmul #b111111111010 X10)  #b000000000011) #b000000000000))
