...
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b000000001001 X1) (bvmul #b000000000101 X2) (bvmul #b000000001010 X3) (bvmul #b111111110111 X4) (bvmul #b000000000010 X5) (bvmul #b111111111001 X6) (bvmul #b111111111000 X7) (bvmul #b111111111110 X8) (bvmul #b000000001010 X9)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b000000000101 X2) (bvmul #b000000000101 X3) (bvmul #b111111111111 X4) (bvmul #b111111111000 X5) (bvmul #b111111111001 X7) (bvmul #b111111111011 X8) (bvmul #b000000000100 X9)  #b111111111001) #b000000000000))
