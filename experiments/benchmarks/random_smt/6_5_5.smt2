...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000001001 X2) (bvmul #b000000000101 X3) (bvmul #b111111111000 X4) (bvmul #b111111111010 X5)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b000000000101 X4) (bvmul #b111111111010 X5)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111110 X5)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X1)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111110110 X2) (bvmul #b000000000001 X3) (bvmul #b000000000010 X5)  #b000000000110) #b000000000000))
