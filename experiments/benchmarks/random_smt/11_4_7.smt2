...
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b000000000110 X2) (bvmul #b000000000011 X3) (bvmul #b000000000010 X4) (bvmul #b111111110110 X7) (bvmul #b000000000100 X8) (bvmul #b000000001000 X9)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b111111111001 X1) (bvmul #b000000000010 X2) (bvmul #b111111111111 X5) (bvmul #b000000001001 X8)  #b111111111101) #b000000000000))
