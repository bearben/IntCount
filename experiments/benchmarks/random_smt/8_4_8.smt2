...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b000000001000 X1) (bvmul #b000000001001 X2) (bvmul #b111111111100 X3) (bvmul #b000000001010 X4) (bvmul #b111111111110 X5) (bvmul #b000000000001 X6) (bvmul #b111111111100 X7)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X0) (bvmul #b000000001001 X1) (bvmul #b000000000011 X2) (bvmul #b111111111010 X3) (bvmul #b000000001010 X6)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X5)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b000000000001 X7)  #b111111111010) #b000000000000))
