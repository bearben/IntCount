...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111000 X4) (bvmul #b000000000011 X5) (bvmul #b111111111100 X9)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X6)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000000001 X2) (bvmul #b000000001000 X6) (bvmul #b111111111011 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3) (bvmul #b000000000100 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X6)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X4) (bvmul #b000000000110 X6) (bvmul #b111111110111 X9)  #b111111111101) #b000000000000))
