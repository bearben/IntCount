...
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111110110 X3) (bvmul #b000000000011 X4) (bvmul #b000000000101 X5) (bvmul #b111111110110 X7) (bvmul #b000000000111 X8) (bvmul #b000000000001 X9) (bvmul #b000000000010 X10)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X3) (bvmul #b111111111000 X7) (bvmul #b000000001001 X10)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111111111 X2) (bvmul #b000000000011 X3) (bvmul #b111111110110 X5) (bvmul #b111111111011 X6) (bvmul #b111111111000 X7) (bvmul #b111111111010 X9) (bvmul #b111111111000 X10)  #b000000000001) #b000000000000))
