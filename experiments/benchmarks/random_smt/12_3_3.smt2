...
(assert (bvsge (bvadd (bvmul #b111111111100 X2) (bvmul #b111111111000 X3) (bvmul #b111111111010 X7)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X10)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b000000001001 X4) (bvmul #b111111111010 X8)  #b111111111100) #b000000000000))
