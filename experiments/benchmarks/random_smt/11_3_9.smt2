...
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b111111111011 X1) (bvmul #b000000001010 X2) (bvmul #b111111111110 X4) (bvmul #b111111111100 X5) (bvmul #b111111110111 X6) (bvmul #b000000000011 X7) (bvmul #b111111111001 X9) (bvmul #b111111111111 X10)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b000000000101 X3) (bvmul #b000000000011 X5) (bvmul #b000000000101 X6) (bvmul #b111111111111 X8) (bvmul #b111111111101 X10)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111111001 X2) (bvmul #b000000000111 X3) (bvmul #b111111110110 X4) (bvmul #b000000001000 X5) (bvmul #b111111110111 X6) (bvmul #b000000000001 X7) (bvmul #b111111111010 X9) (bvmul #b000000000001 X10)  #b000000001010) #b000000000000))
