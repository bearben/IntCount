...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111101 X1) (bvmul #b000000000110 X2) (bvmul #b111111111001 X4) (bvmul #b111111111101 X5) (bvmul #b111111111010 X6) (bvmul #b000000000110 X8) (bvmul #b000000001010 X9) (bvmul #b111111110111 X10)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b111111111111 X1) (bvmul #b000000000111 X2) (bvmul #b111111110111 X5) (bvmul #b000000001001 X6) (bvmul #b111111111011 X7) (bvmul #b111111111100 X9)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X3) (bvmul #b000000001010 X5) (bvmul #b000000000010 X10)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X2) (bvmul #b000000000010 X3) (bvmul #b111111111011 X7) (bvmul #b111111111001 X8)  #b000000000010) #b000000000000))
