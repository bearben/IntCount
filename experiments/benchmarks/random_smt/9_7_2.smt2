...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000101 X5)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X8)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b000000001010 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000001001 X5)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X1)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X5) (bvmul #b111111110111 X6)  #b111111110110) #b000000000000))
