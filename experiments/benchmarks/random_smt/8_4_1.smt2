...
(assert (bvsge (bvadd (bvmul #b000000001001 X1)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X5)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X2)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0)  #b000000000001) #b000000000000))
