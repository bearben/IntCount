...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111001 X1) (bvmul #b000000000100 X2) (bvmul #b111111111010 X4) (bvmul #b000000001001 X6)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000001000 X1) (bvmul #b111111110110 X3) (bvmul #b111111111010 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111100 X2) (bvmul #b111111111100 X3) (bvmul #b111111111000 X5) (bvmul #b000000000001 X6)  #b111111111101) #b000000000000))
