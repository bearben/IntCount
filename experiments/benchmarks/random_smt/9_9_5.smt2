...
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111111011 X4) (bvmul #b000000000001 X5) (bvmul #b111111111000 X7) (bvmul #b111111111111 X8)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2) (bvmul #b000000001010 X7) (bvmul #b000000000101 X8)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b000000000111 X2) (bvmul #b000000000100 X4) (bvmul #b000000000111 X5)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X2) (bvmul #b111111111101 X4) (bvmul #b111111111001 X5) (bvmul #b111111111010 X6) (bvmul #b111111110111 X8)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X4) (bvmul #b111111111111 X5)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111110111 X4) (bvmul #b111111111000 X5) (bvmul #b000000000011 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X5)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X7)  #b000000000011) #b000000000000))
