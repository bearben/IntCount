...
(assert (bvsge (bvadd (bvmul #b000000000011 X2) (bvmul #b111111110111 X3)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b111111111100 X4)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X1)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111010 X4)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111001 X1)  #b000000000100) #b000000000000))
