...
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b000000001000 X1) (bvmul #b000000001001 X3) (bvmul #b111111111100 X4)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b000000001000 X2) (bvmul #b111111110111 X3) (bvmul #b111111111111 X4)  #b111111111100) #b000000000000))
