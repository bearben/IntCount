...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b000000000010 X1) (bvmul #b111111111000 X2) (bvmul #b111111111100 X3) (bvmul #b111111111110 X4) (bvmul #b000000000100 X5) (bvmul #b000000000111 X6) (bvmul #b000000000011 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b111111111111 X3) (bvmul #b111111111111 X7)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b000000000100 X1) (bvmul #b000000000100 X2) (bvmul #b111111111000 X3) (bvmul #b000000000110 X5) (bvmul #b111111110110 X6) (bvmul #b111111111000 X7)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000101 X2) (bvmul #b111111111000 X5) (bvmul #b111111110111 X6) (bvmul #b111111110111 X7)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111010 X1) (bvmul #b111111111001 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b000000000101 X3) (bvmul #b000000001001 X4) (bvmul #b111111111100 X7)  #b000000001001) #b000000000000))
