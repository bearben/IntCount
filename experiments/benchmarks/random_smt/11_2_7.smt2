...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111110110 X2) (bvmul #b000000000100 X3) (bvmul #b111111111111 X6) (bvmul #b000000000011 X7) (bvmul #b111111111011 X8) (bvmul #b000000000111 X9)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111111000 X2) (bvmul #b000000000010 X4) (bvmul #b000000000111 X5) (bvmul #b111111111010 X7) (bvmul #b111111111001 X9) (bvmul #b000000000111 X10)  #b000000000101) #b000000000000))
