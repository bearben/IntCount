...
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b111111110111 X2) (bvmul #b000000000001 X3) (bvmul #b111111111000 X5) (bvmul #b000000000100 X6) (bvmul #b000000000100 X7) (bvmul #b000000000111 X8) (bvmul #b000000000110 X9)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X1) (bvmul #b000000000010 X3) (bvmul #b000000001010 X8)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b111111111001 X3) (bvmul #b111111111001 X5) (bvmul #b111111111011 X6) (bvmul #b000000001000 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111100 X6) (bvmul #b000000000010 X8) (bvmul #b111111111101 X9)  #b111111111001) #b000000000000))
