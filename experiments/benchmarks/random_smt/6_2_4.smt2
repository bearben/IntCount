...
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b111111111101 X1) (bvmul #b111111110110 X2) (bvmul #b111111110110 X3)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b111111111000 X3) (bvmul #b000000001010 X4)  #b000000000111) #b000000000000))
