...
(assert (bvsge (bvadd (bvmul #b000000001000 X1) (bvmul #b000000000111 X2) (bvmul #b000000000111 X3) (bvmul #b111111111001 X4) (bvmul #b000000001000 X6) (bvmul #b000000000100 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X2) (bvmul #b000000000100 X3)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b000000000111 X4)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X2)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111101 X1) (bvmul #b000000000101 X2) (bvmul #b111111111010 X4) (bvmul #b111111111001 X5) (bvmul #b111111111101 X7)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X2) (bvmul #b000000000001 X5) (bvmul #b111111111010 X6) (bvmul #b000000000100 X7)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X4) (bvmul #b111111111101 X8)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b111111111110 X1) (bvmul #b111111111100 X3) (bvmul #b000000000110 X5) (bvmul #b000000000101 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1) (bvmul #b000000001001 X4)  #b000000001000) #b000000000000))
