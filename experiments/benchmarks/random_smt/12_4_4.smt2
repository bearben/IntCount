...
(assert (bvsge (bvadd (bvmul #b111111111010 X1) (bvmul #b000000000110 X2) (bvmul #b111111111100 X5) (bvmul #b111111111100 X8)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b000000000010 X3) (bvmul #b111111110111 X9)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000100 X4) (bvmul #b111111111110 X5)  #b000000001001) #b000000000000))
