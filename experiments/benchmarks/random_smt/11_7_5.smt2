...
(assert (bvsge (bvadd (bvmul #b000000001001 X2) (bvmul #b111111111111 X3) (bvmul #b000000000110 X7) (bvmul #b000000000010 X9) (bvmul #b000000000010 X10)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X4) (bvmul #b111111111011 X10)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X5) (bvmul #b000000001010 X6)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X9) (bvmul #b000000001010 X10)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b111111111101 X5) (bvmul #b000000000100 X8) (bvmul #b000000000010 X10)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X9)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000111 X2) (bvmul #b000000000100 X3) (bvmul #b000000000011 X4) (bvmul #b111111111000 X8)  #b000000000101) #b000000000000))
