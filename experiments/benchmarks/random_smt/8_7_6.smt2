...
(assert (bvsge (bvadd (bvmul #b111111111100 X1) (bvmul #b111111111001 X2) (bvmul #b000000000110 X3) (bvmul #b111111111111 X4) (bvmul #b000000000011 X6) (bvmul #b111111111000 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000000111 X2) (bvmul #b000000000010 X3) (bvmul #b111111111001 X6) (bvmul #b111111111100 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000001000 X1) (bvmul #b000000000110 X2) (bvmul #b000000001001 X4) (bvmul #b111111111101 X5) (bvmul #b111111111011 X6)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000110 X1)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b111111111010 X2) (bvmul #b111111111101 X3) (bvmul #b000000000011 X4) (bvmul #b111111111011 X6) (bvmul #b000000000111 X7)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X3) (bvmul #b000000000001 X5) (bvmul #b111111111111 X6) (bvmul #b000000000110 X7)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X2) (bvmul #b111111111011 X3) (bvmul #b111111111101 X7)  #b111111111000) #b000000000000))
