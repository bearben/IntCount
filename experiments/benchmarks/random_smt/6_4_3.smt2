...
(assert (bvsge (bvadd (bvmul #b000000000001 X0) (bvmul #b000000001010 X1) (bvmul #b000000000110 X5)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b111111111000 X5)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b111111111011 X2) (bvmul #b111111111111 X3)  #b000000000100) #b000000000000))
