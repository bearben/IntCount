...
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b000000001010 X2) (bvmul #b111111111000 X3) (bvmul #b000000001000 X7) (bvmul #b111111111100 X8)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3) (bvmul #b000000000110 X9)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X2) (bvmul #b111111111000 X4)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X6) (bvmul #b111111111110 X7) (bvmul #b111111111111 X9)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X3)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111100 X4)  #b000000000111) #b000000000000))
