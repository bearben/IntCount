...
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000001 X1) (bvmul #b000000000111 X3) (bvmul #b111111111111 X4) (bvmul #b111111111010 X5)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X5)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X2) (bvmul #b111111111101 X4) (bvmul #b000000000101 X5)  #b000000000000) #b000000000000))
