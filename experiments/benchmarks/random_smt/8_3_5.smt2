...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111000 X1) (bvmul #b111111111100 X3) (bvmul #b000000000001 X5) (bvmul #b000000000100 X6)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X4) (bvmul #b111111111010 X5)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000000110 X1) (bvmul #b000000001001 X2) (bvmul #b000000000011 X6)  #b000000000101) #b000000000000))
