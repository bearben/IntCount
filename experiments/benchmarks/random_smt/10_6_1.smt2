...
(assert (bvsge (bvadd (bvmul #b000000001001 X5)  #b111111111000) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b111111111010 X8)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X7)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0)  #b000000000000) #b000000000000))
