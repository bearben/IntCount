...
(assert (bvsge (bvadd (bvmul #b111111111011 X3) (bvmul #b000000001010 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X2)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X2) (bvmul #b111111111110 X4)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X5) (bvmul #b000000001001 X6)  #b000000001000) #b000000000000))
