...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000001000 X4) (bvmul #b111111111011 X5) (bvmul #b000000000011 X6) (bvmul #b000000001000 X8) (bvmul #b111111111010 X9)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000111 X3) (bvmul #b111111111001 X5) (bvmul #b000000001000 X7) (bvmul #b000000000101 X8) (bvmul #b111111111100 X9)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X3) (bvmul #b111111111000 X6) (bvmul #b111111111011 X7)  #b000000000111) #b000000000000))
