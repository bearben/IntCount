...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b000000000001 X1) (bvmul #b000000000110 X3)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b111111111111 X4)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X6)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2) (bvmul #b000000000111 X6)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X2) (bvmul #b111111111000 X5)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X5) (bvmul #b000000001001 X6) (bvmul #b000000001000 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111110 X6)  #b111111111001) #b000000000000))
