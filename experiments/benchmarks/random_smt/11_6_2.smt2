...
(assert (bvsge (bvadd (bvmul #b111111111111 X4) (bvmul #b000000000101 X10)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X8)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111000 X8)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X3) (bvmul #b000000001001 X9)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b000000001001 X5)  #b000000000100) #b000000000000))
