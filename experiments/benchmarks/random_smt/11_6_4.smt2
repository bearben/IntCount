...
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000011 X5) (bvmul #b111111111100 X8) (bvmul #b111111111100 X10)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X5)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X7) (bvmul #b111111111100 X10)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X3) (bvmul #b000000001010 X4) (bvmul #b000000000010 X6) (bvmul #b000000000111 X8)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b111111110111 X8) (bvmul #b000000000110 X10)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111111 X5)  #b000000000111) #b000000000000))
