...
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b000000000101 X2) (bvmul #b111111110110 X3) (bvmul #b000000001010 X4) (bvmul #b111111111011 X5) (bvmul #b111111111111 X6)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b000000000001 X4) (bvmul #b000000001010 X5) (bvmul #b111111111110 X6)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111101 X2) (bvmul #b111111111101 X3) (bvmul #b000000000100 X5) (bvmul #b000000000110 X6)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b000000000101 X4) (bvmul #b111111111101 X5) (bvmul #b111111111001 X6)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b000000000110 X6)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111111 X2) (bvmul #b111111111100 X5) (bvmul #b111111110110 X6)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X4)  #b111111110110) #b000000000000))
