...
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000001 X1) (bvmul #b000000001000 X2) (bvmul #b111111110110 X3) (bvmul #b111111111001 X4) (bvmul #b000000000111 X5) (bvmul #b111111111100 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000000111 X2) (bvmul #b111111111101 X3) (bvmul #b111111111101 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111110110 X1) (bvmul #b111111111111 X2) (bvmul #b111111111111 X3) (bvmul #b000000000111 X5) (bvmul #b111111111011 X6)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111111110 X3) (bvmul #b111111111010 X4) (bvmul #b111111111110 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111000 X1) (bvmul #b000000000010 X3) (bvmul #b000000000110 X4) (bvmul #b000000000110 X6) (bvmul #b000000000011 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b000000001000 X2) (bvmul #b111111110110 X4) (bvmul #b111111110111 X7)  #b000000000001) #b000000000000))
