...
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b111111111001 X2) (bvmul #b000000000100 X6)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X4)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X7)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X3) (bvmul #b000000001010 X8)  #b000000000001) #b000000000000))
