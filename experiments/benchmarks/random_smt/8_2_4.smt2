...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111100 X4) (bvmul #b000000001010 X5) (bvmul #b000000001010 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X4) (bvmul #b111111111000 X5) (bvmul #b000000000011 X6)  #b000000000001) #b000000000000))
