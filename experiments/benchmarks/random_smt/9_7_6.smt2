...
(assert (bvsge (bvadd (bvmul #b111111111001 X2) (bvmul #b000000000011 X3) (bvmul #b000000000100 X4) (bvmul #b111111111111 X5) (bvmul #b111111111001 X7) (bvmul #b111111111010 X8)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111110111 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b000000000111 X5) (bvmul #b000000000001 X7) (bvmul #b000000001010 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111101 X2) (bvmul #b111111111011 X3) (bvmul #b000000000010 X5) (bvmul #b000000000010 X6) (bvmul #b000000001010 X8)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X3) (bvmul #b111111111110 X5)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000100 X4) (bvmul #b111111111001 X6)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b111111111011 X3) (bvmul #b111111111001 X4) (bvmul #b111111111110 X6) (bvmul #b111111111000 X8)  #b111111111001) #b000000000000))
