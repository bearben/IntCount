...
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111111011 X1) (bvmul #b000000000110 X2) (bvmul #b111111111010 X3) (bvmul #b000000000100 X4)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111111110 X1) (bvmul #b000000000010 X2)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111111 X1) (bvmul #b000000000111 X2) (bvmul #b111111111001 X3) (bvmul #b000000000010 X4)  #b111111111000) #b000000000000))
