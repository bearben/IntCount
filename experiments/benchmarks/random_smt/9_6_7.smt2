...
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b000000000111 X2) (bvmul #b000000000110 X4) (bvmul #b000000001001 X5) (bvmul #b111111111001 X6) (bvmul #b111111111001 X7) (bvmul #b111111111000 X8)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X2) (bvmul #b000000000001 X5)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b111111111011 X2) (bvmul #b000000000010 X4) (bvmul #b111111111001 X5) (bvmul #b000000000011 X7) (bvmul #b111111111011 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X5)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X2) (bvmul #b111111110110 X4) (bvmul #b000000001010 X8)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b000000000010 X1) (bvmul #b000000000110 X2) (bvmul #b000000000001 X5) (bvmul #b111111111110 X6) (bvmul #b000000000111 X7) (bvmul #b000000000010 X8)  #b111111111010) #b000000000000))
