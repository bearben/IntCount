...
(assert (bvsge (bvadd (bvmul #b000000000110 X3) (bvmul #b111111111011 X5) (bvmul #b000000000101 X8) (bvmul #b111111111110 X11) (bvmul #b111111111111 X13)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X8)  #b000000001001) #b000000000000))
