...
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000000001 X1) (bvmul #b111111111000 X2) (bvmul #b111111111000 X3) (bvmul #b111111111100 X5) (bvmul #b111111111110 X6)  #b111111111101) #b000000000000))
