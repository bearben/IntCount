...
(assert (bvsge (bvadd (bvmul #b111111111000 X2) (bvmul #b111111110111 X3) (bvmul #b111111111111 X5)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b000000000010 X4) (bvmul #b111111111111 X5)  #b000000000101) #b000000000000))
