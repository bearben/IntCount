...
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111110111 X1) (bvmul #b000000001010 X3) (bvmul #b111111111000 X4) (bvmul #b000000000011 X6) (bvmul #b111111111001 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111101 X2) (bvmul #b111111111011 X3) (bvmul #b000000000101 X5) (bvmul #b000000001000 X6)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X1) (bvmul #b000000000111 X2) (bvmul #b111111111100 X4) (bvmul #b111111111001 X5)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X4) (bvmul #b000000000011 X6)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b000000000001 X4) (bvmul #b000000000011 X8)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X9)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X4) (bvmul #b111111110110 X5)  #b111111111011) #b000000000000))
