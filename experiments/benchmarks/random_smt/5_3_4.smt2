...
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000000110 X1) (bvmul #b000000001001 X2) (bvmul #b000000000011 X3)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000101 X1) (bvmul #b000000000011 X2) (bvmul #b000000001001 X4)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000111 X1) (bvmul #b111111111010 X4)  #b111111111000) #b000000000000))
