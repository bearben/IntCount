...
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b111111111010 X1) (bvmul #b000000001010 X2) (bvmul #b000000000101 X3) (bvmul #b000000000001 X6)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111000 X1) (bvmul #b111111111110 X2) (bvmul #b000000000010 X3) (bvmul #b000000000100 X5)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000010 X1) (bvmul #b111111111001 X3) (bvmul #b000000001000 X7)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X2) (bvmul #b111111111010 X6)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X2) (bvmul #b000000000110 X4) (bvmul #b000000000010 X5)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b111111111101 X1) (bvmul #b000000000011 X3) (bvmul #b111111111101 X6) (bvmul #b111111111010 X7)  #b111111111101) #b000000000000))
