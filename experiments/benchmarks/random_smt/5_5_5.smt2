...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000000110 X1) (bvmul #b111111110111 X2) (bvmul #b111111111111 X3) (bvmul #b111111111100 X4)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b000000000101 X3) (bvmul #b000000000010 X4)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111000 X1) (bvmul #b111111111111 X2) (bvmul #b000000000101 X4)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b000000000011 X3)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X3) (bvmul #b000000000001 X4)  #b111111111000) #b000000000000))
