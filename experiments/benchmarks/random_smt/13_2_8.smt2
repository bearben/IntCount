...
(assert (bvsge (bvadd (bvmul #b111111111010 X2) (bvmul #b000000001000 X3) (bvmul #b000000000011 X5) (bvmul #b111111111101 X7) (bvmul #b000000000101 X9) (bvmul #b000000000001 X10) (bvmul #b000000000110 X11) (bvmul #b000000000010 X12)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X3) (bvmul #b111111111011 X6) (bvmul #b111111111001 X9)  #b000000001000) #b000000000000))
