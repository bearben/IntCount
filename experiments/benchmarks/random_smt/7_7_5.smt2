...
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111110111 X2) (bvmul #b111111111111 X3) (bvmul #b000000001010 X4) (bvmul #b111111110110 X5)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111101 X1) (bvmul #b000000001001 X2) (bvmul #b111111111110 X4) (bvmul #b111111111111 X6)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b000000000111 X4) (bvmul #b000000001001 X5)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X2)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000000010 X2) (bvmul #b111111111110 X6)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111110110 X1) (bvmul #b111111111110 X2) (bvmul #b000000001010 X4) (bvmul #b000000000001 X5)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b000000000010 X1) (bvmul #b111111111111 X3) (bvmul #b111111111010 X4) (bvmul #b000000001001 X6)  #b111111111101) #b000000000000))
