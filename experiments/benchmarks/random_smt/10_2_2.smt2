...
(assert (bvsge (bvadd (bvmul #b000000001001 X5) (bvmul #b111111111000 X7)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X5) (bvmul #b111111111100 X8)  #b111111111101) #b000000000000))
