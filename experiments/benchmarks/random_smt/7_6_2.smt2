...
(assert (bvsge (bvadd (bvmul #b000000000111 X4) (bvmul #b111111110111 X5)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X1) (bvmul #b111111110111 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X5)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000010 X1)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000001010 X6)  #b000000000010) #b000000000000))
