...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b000000000010 X1) (bvmul #b111111111001 X2) (bvmul #b111111111110 X3) (bvmul #b111111111110 X4)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b111111110110 X2) (bvmul #b000000000101 X4)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b111111111011 X4)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000001000 X1) (bvmul #b000000000110 X2) (bvmul #b111111111010 X3) (bvmul #b111111110110 X4)  #b000000000010) #b000000000000))
