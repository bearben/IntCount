...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111010 X1) (bvmul #b000000000110 X2) (bvmul #b000000000010 X4)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000000001 X2)  #b111111111100) #b000000000000))
