...
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000110 X2) (bvmul #b000000000010 X3) (bvmul #b111111111000 X4) (bvmul #b000000001001 X5)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X3) (bvmul #b111111111000 X5) (bvmul #b000000000100 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000001 X4) (bvmul #b111111110111 X5) (bvmul #b000000000101 X6)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X4)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X5)  #b111111110110) #b000000000000))
