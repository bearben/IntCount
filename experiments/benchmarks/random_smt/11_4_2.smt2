...
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b111111110111 X7)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X10)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X4) (bvmul #b000000000011 X8)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X5) (bvmul #b111111110111 X9)  #b000000001001) #b000000000000))
