...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111101 X1) (bvmul #b000000000001 X2) (bvmul #b111111111011 X3) (bvmul #b000000001000 X5)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000011 X2) (bvmul #b111111111010 X4) (bvmul #b111111111000 X5)  #b000000000100) #b000000000000))
