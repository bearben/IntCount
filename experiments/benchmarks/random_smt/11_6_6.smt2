...
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111111110 X4) (bvmul #b111111111010 X5) (bvmul #b111111111110 X6) (bvmul #b000000000110 X7) (bvmul #b000000000011 X8)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b000000000100 X4) (bvmul #b111111110111 X9)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X5) (bvmul #b111111110111 X6) (bvmul #b111111111001 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000001010 X3) (bvmul #b000000000011 X10)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X2)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000111 X1) (bvmul #b111111110110 X3) (bvmul #b000000001001 X6) (bvmul #b111111111001 X10)  #b000000000101) #b000000000000))
