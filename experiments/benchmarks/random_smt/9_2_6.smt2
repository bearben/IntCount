...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111100 X1) (bvmul #b111111111001 X2) (bvmul #b000000000111 X4) (bvmul #b111111111100 X7) (bvmul #b000000000011 X8)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X5)  #b111111111110) #b000000000000))
