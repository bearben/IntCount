...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000000111 X2) (bvmul #b000000000101 X3) (bvmul #b111111111111 X4) (bvmul #b000000000010 X5) (bvmul #b000000000110 X6) (bvmul #b000000000010 X7) (bvmul #b111111110111 X8) (bvmul #b111111111011 X10) (bvmul #b111111111111 X11)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000001000 X1) (bvmul #b000000000100 X2) (bvmul #b000000000110 X3) (bvmul #b111111111110 X4) (bvmul #b000000000001 X6) (bvmul #b111111111110 X7) (bvmul #b111111111101 X9) (bvmul #b000000000011 X10) (bvmul #b000000000010 X11)  #b111111110110) #b000000000000))
