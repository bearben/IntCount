...
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111111101 X2) (bvmul #b000000001000 X4) (bvmul #b000000000111 X5) (bvmul #b000000000010 X6) (bvmul #b111111110111 X7) (bvmul #b000000000001 X8) (bvmul #b111111111010 X9) (bvmul #b111111110111 X10) (bvmul #b111111111000 X11)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X1) (bvmul #b111111110111 X3) (bvmul #b111111111000 X6) (bvmul #b000000000001 X7) (bvmul #b111111111100 X9)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111101 X4) (bvmul #b000000000101 X5)  #b000000000100) #b000000000000))
