...
(assert (bvsge (bvadd (bvmul #b111111111100 X1)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X2)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X3)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X8)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X0)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X7)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X4)  #b111111111011) #b000000000000))
