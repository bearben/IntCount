...
(assert (bvsge (bvadd (bvmul #b111111111111 X3) (bvmul #b111111110110 X5) (bvmul #b000000001010 X7)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X8) (bvmul #b111111111101 X9)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b111111111110 X7) (bvmul #b000000001010 X8)  #b000000000010) #b000000000000))
