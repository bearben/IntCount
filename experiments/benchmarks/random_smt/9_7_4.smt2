...
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111110110 X3) (bvmul #b000000000100 X5) (bvmul #b000000000110 X6)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b000000000101 X3)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b111111111111 X4)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X8)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X2) (bvmul #b000000001000 X4) (bvmul #b000000000110 X6)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X7)  #b111111111101) #b000000000000))
