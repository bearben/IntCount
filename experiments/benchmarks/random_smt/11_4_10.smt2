...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111011 X1) (bvmul #b000000001001 X2) (bvmul #b111111111001 X3) (bvmul #b000000001010 X4) (bvmul #b111111111101 X5) (bvmul #b000000000010 X6) (bvmul #b000000000001 X7) (bvmul #b111111111001 X9) (bvmul #b000000000001 X10)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X6)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b000000000110 X2)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111110111 X1) (bvmul #b111111110110 X3) (bvmul #b111111111010 X4) (bvmul #b111111110110 X5) (bvmul #b000000000011 X6) (bvmul #b000000000100 X8) (bvmul #b111111111110 X10)  #b111111111000) #b000000000000))
