...
(assert (bvsge (bvadd (bvmul #b111111111011 X2) (bvmul #b000000000100 X5)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X1)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X2) (bvmul #b000000000011 X4)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X3)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X3) (bvmul #b111111111000 X6)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X3)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X4) (bvmul #b111111111000 X6)  #b111111111100) #b000000000000))
