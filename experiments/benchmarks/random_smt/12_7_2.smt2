...
(assert (bvsge (bvadd (bvmul #b000000001001 X3) (bvmul #b111111111010 X4)  #b111111110111) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b111111111011 X3) (bvmul #b111111110111 X4)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X8)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X5)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b111111111010 X10)  #b000000000010) #b000000000000))
