...
(assert (bvsge (bvadd (bvmul #b111111111101 X8)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X2)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X11)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X10)  #b111111110110) #b000000000000))
