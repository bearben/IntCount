...
(assert (bvsge (bvadd (bvmul #b111111111110 X2)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X6)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X4)  #b000000001001) #b000000000000))
