...
(assert (bvsge (bvadd (bvmul #b000000001000 X1)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X7)  #b111111111111) #b000000000000))
