...
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b111111111111 X1) (bvmul #b111111111100 X2) (bvmul #b111111111100 X5) (bvmul #b111111111000 X6) (bvmul #b000000000010 X8)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X6) (bvmul #b000000001000 X8)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X7)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111001 X4)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X3) (bvmul #b000000000110 X6) (bvmul #b111111111011 X7) (bvmul #b111111111000 X8)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X7) (bvmul #b111111110110 X8)  #b000000001000) #b000000000000))
