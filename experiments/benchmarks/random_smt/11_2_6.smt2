...
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111010 X2) (bvmul #b000000000100 X4) (bvmul #b111111111001 X5) (bvmul #b111111111011 X6) (bvmul #b111111111001 X7)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X5)  #b000000000001) #b000000000000))
