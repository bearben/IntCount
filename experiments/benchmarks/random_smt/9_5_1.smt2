...
(assert (bvsge (bvadd (bvmul #b111111111001 X7)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X6)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X4)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X8)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X5)  #b111111111111) #b000000000000))
