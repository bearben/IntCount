...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b000000000110 X1) (bvmul #b000000001000 X3) (bvmul #b000000000111 X5)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X2)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X5)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111001 X1) (bvmul #b000000001010 X4) (bvmul #b000000000001 X5)  #b000000000111) #b000000000000))
