...
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111011 X7)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000011 X8)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X3) (bvmul #b000000000011 X5)  #b111111111000) #b000000000000))
