...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b000000001001 X4) (bvmul #b111111111110 X5)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b000000000101 X5)  #b000000000110) #b000000000000))
