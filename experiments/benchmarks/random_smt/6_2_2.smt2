...
(assert (bvsge (bvadd (bvmul #b111111111110 X3) (bvmul #b000000000011 X5)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X3) (bvmul #b111111111101 X4)  #b111111111110) #b000000000000))
