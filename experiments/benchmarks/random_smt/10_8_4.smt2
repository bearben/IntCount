...
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b000000001001 X3) (bvmul #b111111111100 X4) (bvmul #b000000000101 X5)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000000110 X6) (bvmul #b111111111001 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X3) (bvmul #b111111111000 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X5) (bvmul #b111111111000 X6) (bvmul #b000000000001 X9)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111101 X2) (bvmul #b000000000001 X3) (bvmul #b111111111111 X7)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111010 X4) (bvmul #b111111111001 X8)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X9)  #b000000000010) #b000000000000))
