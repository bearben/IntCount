...
(assert (bvsge (bvadd (bvmul #b000000001010 X2) (bvmul #b111111111100 X5)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111011 X4)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X6)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000111 X5)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3) (bvmul #b111111111000 X5)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X3)  #b000000000111) #b000000000000))
