...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111100 X1) (bvmul #b000000001001 X2) (bvmul #b111111111001 X3) (bvmul #b111111111100 X4) (bvmul #b000000001000 X5) (bvmul #b111111110111 X6)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X5)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X4)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b000000001010 X2) (bvmul #b111111111101 X3) (bvmul #b111111111011 X4)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111011 X2)  #b000000000110) #b000000000000))
