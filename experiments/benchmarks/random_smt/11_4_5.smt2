...
(assert (bvsge (bvadd (bvmul #b000000000001 X0) (bvmul #b111111111000 X4) (bvmul #b111111111100 X5) (bvmul #b000000001010 X8) (bvmul #b000000000111 X10)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X2) (bvmul #b000000000110 X3) (bvmul #b000000000010 X5) (bvmul #b111111111010 X6) (bvmul #b111111111100 X9)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b000000000110 X8)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000001010 X1) (bvmul #b000000000010 X4) (bvmul #b111111111100 X5) (bvmul #b000000000101 X8)  #b000000000110) #b000000000000))
