...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000110 X1) (bvmul #b000000001010 X2) (bvmul #b000000000110 X3)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111110 X1)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X1)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b111111111000 X4)  #b000000001001) #b000000000000))
