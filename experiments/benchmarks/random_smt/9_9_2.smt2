...
(assert (bvsge (bvadd (bvmul #b111111111011 X4) (bvmul #b111111111111 X8)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111110110 X7)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X2) (bvmul #b000000000010 X8)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X1) (bvmul #b111111111000 X4)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X2)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X4) (bvmul #b000000000101 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X1) (bvmul #b000000000011 X3)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X4) (bvmul #b111111110110 X8)  #b000000000011) #b000000000000))
