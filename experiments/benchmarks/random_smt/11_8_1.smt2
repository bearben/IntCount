...
(assert (bvsge (bvadd (bvmul #b111111111111 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X8)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X7)  #b000000000000) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b000000001010 X1)  #b000000000100) #b000000000000))
