...
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111111100 X3)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X7)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b111111111100 X8)  #b111111111011) #b000000000000))
