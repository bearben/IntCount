...
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b000000001000 X2) (bvmul #b111111111111 X3)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X4)  #b000000000100) #b000000000000))
