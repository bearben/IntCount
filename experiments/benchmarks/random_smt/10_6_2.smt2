...
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b111111111101 X9)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X4)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X1)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X8)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000001001 X5)  #b000000000010) #b000000000000))
