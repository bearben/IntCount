...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111101 X1) (bvmul #b111111111100 X2) (bvmul #b000000000100 X3) (bvmul #b111111111110 X6) (bvmul #b111111111100 X8)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X4) (bvmul #b111111110110 X7)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X3)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b000000000110 X2) (bvmul #b000000001010 X4) (bvmul #b111111111110 X6) (bvmul #b000000000101 X7) (bvmul #b111111111011 X8)  #b000000001001) #b000000000000))
