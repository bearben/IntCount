...
(assert (bvsge (bvadd (bvmul #b111111111001 X2) (bvmul #b111111111101 X3) (bvmul #b111111111100 X7) (bvmul #b111111111101 X8)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X2) (bvmul #b000000000011 X8)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b111111111110 X6)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b000000001001 X2) (bvmul #b111111111101 X3)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b111111110110 X2) (bvmul #b000000001001 X6) (bvmul #b111111111001 X7)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b111111111001 X1) (bvmul #b000000000001 X7) (bvmul #b000000000100 X8)  #b000000000011) #b000000000000))
