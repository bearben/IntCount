...
(assert (bvsge (bvadd (bvmul #b000000000111 X2) (bvmul #b111111110111 X7) (bvmul #b111111111110 X11) (bvmul #b111111111010 X12)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X2) (bvmul #b111111111111 X3) (bvmul #b000000001010 X7) (bvmul #b111111111100 X11)  #b000000000010) #b000000000000))
