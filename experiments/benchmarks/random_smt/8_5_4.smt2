...
(assert (bvsge (bvadd (bvmul #b111111111001 X3) (bvmul #b111111111100 X4) (bvmul #b000000000011 X5) (bvmul #b111111110111 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X5)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X2) (bvmul #b000000000001 X4) (bvmul #b111111111010 X5) (bvmul #b000000000111 X7)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X1) (bvmul #b111111111000 X2) (bvmul #b111111111011 X3) (bvmul #b111111111110 X4)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X2) (bvmul #b111111111001 X4) (bvmul #b111111110111 X5) (bvmul #b111111110111 X7)  #b111111111001) #b000000000000))
