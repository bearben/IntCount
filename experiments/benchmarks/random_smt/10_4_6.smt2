...
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111011 X1) (bvmul #b000000000110 X4) (bvmul #b111111111011 X6) (bvmul #b000000000111 X7) (bvmul #b111111111001 X9)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X1) (bvmul #b111111111011 X3) (bvmul #b000000000001 X5) (bvmul #b111111111110 X6) (bvmul #b000000000010 X8) (bvmul #b111111111011 X9)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X1) (bvmul #b000000001000 X2) (bvmul #b111111110110 X3) (bvmul #b000000000011 X4) (bvmul #b111111111011 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X3) (bvmul #b000000001010 X4) (bvmul #b000000000111 X6) (bvmul #b000000000010 X8)  #b111111111010) #b000000000000))
