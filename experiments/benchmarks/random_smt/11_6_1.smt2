...
(assert (bvsge (bvadd (bvmul #b111111111110 X2)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X10)  #b111111111010) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b111111110110 X3)  #b111111111000) #b000000000000))
