...
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b111111111011 X3) (bvmul #b111111111100 X4) (bvmul #b111111111101 X7) (bvmul #b000000001000 X8) (bvmul #b111111110110 X9) (bvmul #b000000000010 X11)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X1) (bvmul #b000000000100 X8) (bvmul #b000000001001 X10) (bvmul #b111111111011 X12)  #b000000000100) #b000000000000))
