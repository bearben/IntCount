...
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b000000000010 X9)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X5)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X6)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X4)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000011 X10)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X4)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b111111111100 X6)  #b000000001000) #b000000000000))
