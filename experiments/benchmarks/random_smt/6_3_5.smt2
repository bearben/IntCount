...
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000001000 X1) (bvmul #b000000000101 X2) (bvmul #b111111111011 X3) (bvmul #b000000000010 X5)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b000000000110 X1) (bvmul #b111111111101 X2) (bvmul #b111111111110 X3) (bvmul #b111111111001 X5)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000001 X1) (bvmul #b000000000001 X2) (bvmul #b000000000100 X4) (bvmul #b111111111111 X5)  #b000000000101) #b000000000000))
