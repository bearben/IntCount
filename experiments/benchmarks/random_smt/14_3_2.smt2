...
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111111000 X1)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X8) (bvmul #b000000000111 X11)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X9) (bvmul #b111111111001 X12)  #b111111111100) #b000000000000))
