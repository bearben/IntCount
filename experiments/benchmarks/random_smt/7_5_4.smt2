...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111100 X3) (bvmul #b111111111011 X4) (bvmul #b000000000001 X6)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b000000000010 X3)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111110111 X2)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X3) (bvmul #b111111110111 X5)  #b000000000010) #b000000000000))
