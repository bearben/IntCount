...
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111110111 X4) (bvmul #b111111111101 X6) (bvmul #b000000000010 X8) (bvmul #b111111111001 X10)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b000000000001 X3) (bvmul #b111111111010 X11)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b000000000011 X12)  #b111111111101) #b000000000000))
