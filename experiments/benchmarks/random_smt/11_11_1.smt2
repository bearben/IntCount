...
(assert (bvsge (bvadd (bvmul #b000000000101 X8)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X1)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X4)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X2)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X6)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X5)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X10)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0)  #b111111111000) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b000000000111 X4)  #b000000000110) #b000000000000))
