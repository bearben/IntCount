...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b111111111011 X1) (bvmul #b000000001000 X2) (bvmul #b111111111000 X3) (bvmul #b000000000110 X4) (bvmul #b111111111001 X5) (bvmul #b000000000011 X6) (bvmul #b000000000010 X7)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X1) (bvmul #b111111111011 X6) (bvmul #b000000000100 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111111100 X1) (bvmul #b000000001000 X2) (bvmul #b000000000011 X3) (bvmul #b000000000001 X4) (bvmul #b000000000101 X5) (bvmul #b111111111111 X6)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X4) (bvmul #b111111111100 X7)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b111111111001 X3) (bvmul #b000000000010 X5) (bvmul #b000000000011 X7)  #b000000000101) #b000000000000))
