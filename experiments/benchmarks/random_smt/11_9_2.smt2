...
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b111111111001 X4)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X7) (bvmul #b111111111111 X10)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X4) (bvmul #b111111111100 X9)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X10)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X6) (bvmul #b111111111100 X8)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X3) (bvmul #b111111111000 X7)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X2)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111111111 X3)  #b111111110110) #b000000000000))
