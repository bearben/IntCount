...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111110111 X1) (bvmul #b000000000110 X2) (bvmul #b111111111111 X5) (bvmul #b000000001010 X9)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b111111110111 X4) (bvmul #b000000000010 X5) (bvmul #b000000000001 X7) (bvmul #b000000000101 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111111110 X2) (bvmul #b111111110111 X8) (bvmul #b111111111001 X10)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111001 X5) (bvmul #b111111110111 X11)  #b000000000110) #b000000000000))
