...
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b000000001000 X6) (bvmul #b111111110111 X11)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X7) (bvmul #b111111111100 X9)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X4) (bvmul #b000000000001 X9) (bvmul #b111111111100 X11)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X2) (bvmul #b000000000011 X8) (bvmul #b111111111000 X11)  #b000000001010) #b000000000000))
