...
(assert (bvsge (bvadd (bvmul #b111111110111 X2) (bvmul #b111111111011 X3) (bvmul #b000000000100 X5) (bvmul #b111111111010 X8) (bvmul #b111111111011 X9)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X1) (bvmul #b111111111101 X8) (bvmul #b111111111111 X9)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111100 X9)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000011 X2) (bvmul #b111111111100 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b000000000010 X5) (bvmul #b000000001000 X6) (bvmul #b000000000110 X8)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2) (bvmul #b000000000010 X4) (bvmul #b000000001000 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X5) (bvmul #b111111111001 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X4) (bvmul #b111111111000 X5)  #b000000000000) #b000000000000))
