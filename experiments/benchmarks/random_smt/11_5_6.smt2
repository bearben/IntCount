...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111011 X1) (bvmul #b000000000111 X4) (bvmul #b111111111111 X7) (bvmul #b111111111000 X8) (bvmul #b000000000101 X9)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X2) (bvmul #b111111111111 X5) (bvmul #b111111111010 X6) (bvmul #b000000001010 X10)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111110110 X1) (bvmul #b111111111011 X3) (bvmul #b000000001000 X4) (bvmul #b111111111100 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X3) (bvmul #b111111111111 X7)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X8) (bvmul #b000000000110 X10)  #b111111111101) #b000000000000))
