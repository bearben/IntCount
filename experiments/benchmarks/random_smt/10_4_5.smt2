...
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b111111111101 X3) (bvmul #b000000001010 X4) (bvmul #b111111111010 X6) (bvmul #b111111111110 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X8) (bvmul #b000000000100 X9)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111111011 X1) (bvmul #b000000000010 X8)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X1) (bvmul #b000000000110 X5)  #b000000000011) #b000000000000))
