...
(assert (bvsge (bvadd (bvmul #b111111111111 X1) (bvmul #b111111110111 X3) (bvmul #b000000001010 X4) (bvmul #b111111110111 X9)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b111111110111 X7) (bvmul #b000000000110 X8) (bvmul #b000000000101 X9)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X1)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X6) (bvmul #b000000000110 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b000000001001 X2) (bvmul #b111111111001 X6)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111110 X1) (bvmul #b000000000100 X4) (bvmul #b000000000011 X7)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111011 X3) (bvmul #b000000001010 X6) (bvmul #b000000000001 X8)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2)  #b111111110111) #b000000000000))
