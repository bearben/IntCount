...
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000001000 X2) (bvmul #b000000001010 X5) (bvmul #b000000000010 X6) (bvmul #b000000000101 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X2) (bvmul #b000000000101 X3) (bvmul #b000000000110 X6) (bvmul #b111111111010 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X2) (bvmul #b000000000010 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X2) (bvmul #b111111111100 X3) (bvmul #b111111111010 X5) (bvmul #b000000001000 X6)  #b111111111100) #b000000000000))
