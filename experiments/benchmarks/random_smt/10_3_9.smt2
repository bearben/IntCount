...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b000000001000 X1) (bvmul #b000000001010 X2) (bvmul #b000000000110 X3) (bvmul #b111111111111 X4) (bvmul #b000000000011 X5) (bvmul #b000000000010 X6) (bvmul #b000000000101 X7) (bvmul #b000000000100 X9)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111110 X2) (bvmul #b000000000011 X3) (bvmul #b000000001001 X9)  #b111111111111) #b000000000000))
