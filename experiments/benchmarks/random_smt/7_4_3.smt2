...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111110111 X2) (bvmul #b000000000001 X3)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X5) (bvmul #b000000000100 X6)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X3)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X5) (bvmul #b000000000010 X6)  #b111111110110) #b000000000000))
