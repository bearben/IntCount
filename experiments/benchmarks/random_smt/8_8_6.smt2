...
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b111111111101 X2) (bvmul #b000000001000 X3) (bvmul #b111111111110 X4) (bvmul #b000000001001 X6) (bvmul #b000000001001 X7)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b000000000100 X4) (bvmul #b111111111101 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X6) (bvmul #b000000001000 X7)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000001010 X1) (bvmul #b111111111001 X2) (bvmul #b111111110110 X6) (bvmul #b111111111111 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X5)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X2) (bvmul #b111111111110 X4) (bvmul #b111111111011 X6)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X1) (bvmul #b000000000100 X5)  #b000000000010) #b000000000000))
