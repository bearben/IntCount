...
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b111111111001 X2)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000001010 X5)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b000000000010 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111001 X3)  #b111111111111) #b000000000000))
