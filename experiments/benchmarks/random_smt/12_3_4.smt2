...
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b000000000011 X5) (bvmul #b000000000111 X6) (bvmul #b000000000111 X10)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X3)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X7) (bvmul #b111111111001 X10)  #b111111111101) #b000000000000))
