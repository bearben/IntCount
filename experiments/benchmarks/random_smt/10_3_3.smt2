...
(assert (bvsge (bvadd (bvmul #b000000000011 X5) (bvmul #b111111111111 X6) (bvmul #b111111110110 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X1) (bvmul #b111111110110 X5) (bvmul #b000000000011 X8)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X8) (bvmul #b000000001000 X9)  #b000000000000) #b000000000000))
