...
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111111000 X7) (bvmul #b111111110110 X9)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X3) (bvmul #b111111111101 X4)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X5)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b111111111000 X2) (bvmul #b111111111101 X3)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000100 X5)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b000000001000 X2)  #b000000000101) #b000000000000))
