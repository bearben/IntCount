...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111110111 X1) (bvmul #b111111111101 X2) (bvmul #b000000000101 X3)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X5)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b111111110111 X2) (bvmul #b111111111111 X4) (bvmul #b111111110110 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000011 X1) (bvmul #b111111111001 X3) (bvmul #b111111111110 X6)  #b000000000011) #b000000000000))
