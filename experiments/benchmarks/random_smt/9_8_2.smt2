...
(assert (bvsge (bvadd (bvmul #b111111111101 X3) (bvmul #b000000001010 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X8)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X3)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X2) (bvmul #b111111110110 X3)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b000000001001 X4)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X4) (bvmul #b000000001001 X6)  #b000000000001) #b000000000000))
