...
(assert (bvsge (bvadd (bvmul #b111111111101 X2) (bvmul #b000000001010 X4)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X5) (bvmul #b000000000100 X8)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X2) (bvmul #b111111111000 X7)  #b111111111001) #b000000000000))
