...
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b000000000101 X4) (bvmul #b000000001001 X6) (bvmul #b000000000101 X7)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X4) (bvmul #b000000001000 X5)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X3) (bvmul #b000000000011 X4) (bvmul #b111111110110 X7)  #b000000001010) #b000000000000))
