...
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b000000000101 X2) (bvmul #b000000001000 X6)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X4) (bvmul #b111111111001 X7)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X2) (bvmul #b000000000100 X3)  #b111111111010) #b000000000000))
