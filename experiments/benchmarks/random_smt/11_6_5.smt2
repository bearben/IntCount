...
(assert (bvsge (bvadd (bvmul #b000000000110 X1) (bvmul #b111111111111 X2) (bvmul #b111111111001 X5) (bvmul #b111111111111 X8) (bvmul #b000000000010 X10)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b000000000011 X7) (bvmul #b111111111000 X8) (bvmul #b111111111101 X10)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3) (bvmul #b111111111000 X5) (bvmul #b000000000111 X8)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X1) (bvmul #b111111110110 X2) (bvmul #b000000000010 X3) (bvmul #b111111110110 X6) (bvmul #b111111111001 X8)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X6) (bvmul #b111111111001 X8)  #b111111111101) #b000000000000))
