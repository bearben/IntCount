...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000000001 X1) (bvmul #b000000001010 X3) (bvmul #b111111111111 X4) (bvmul #b111111111011 X6) (bvmul #b111111110110 X7) (bvmul #b000000000101 X8) (bvmul #b111111110111 X9)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000001001 X2) (bvmul #b000000001001 X5) (bvmul #b111111111110 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111101 X2) (bvmul #b111111111010 X3) (bvmul #b000000000001 X7) (bvmul #b000000000010 X9)  #b000000000010) #b000000000000))
