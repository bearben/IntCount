...
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000001010 X1) (bvmul #b000000000100 X4) (bvmul #b000000001010 X5)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X2) (bvmul #b111111110111 X3) (bvmul #b000000000010 X5) (bvmul #b111111111101 X6)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X4) (bvmul #b111111111011 X6)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X4) (bvmul #b000000000110 X5) (bvmul #b111111110110 X6)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b111111111001 X2)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b000000001010 X2) (bvmul #b000000001010 X3) (bvmul #b111111111110 X6)  #b000000001010) #b000000000000))
