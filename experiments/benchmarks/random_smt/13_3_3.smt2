...
(assert (bvsge (bvadd (bvmul #b000000001001 X3) (bvmul #b111111111110 X5) (bvmul #b111111111100 X11)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X1) (bvmul #b111111111010 X2)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X4)  #b111111111011) #b000000000000))
