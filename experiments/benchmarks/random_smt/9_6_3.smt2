...
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b000000000100 X6) (bvmul #b111111110111 X8)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X4)  #b000000000000) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b111111111101 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b000000000010 X4) (bvmul #b000000000001 X5)  #b000000000110) #b000000000000))
