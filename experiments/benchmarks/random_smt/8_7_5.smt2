...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111111 X2) (bvmul #b000000000100 X3) (bvmul #b111111111011 X5) (bvmul #b111111111101 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X2) (bvmul #b111111111101 X3) (bvmul #b111111111111 X5)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b000000000010 X4) (bvmul #b000000001000 X5)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000001010 X1) (bvmul #b111111111000 X3) (bvmul #b111111111001 X6) (bvmul #b000000000001 X7)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111111 X1) (bvmul #b000000000110 X2) (bvmul #b111111110111 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b000000000111 X2) (bvmul #b111111111011 X4) (bvmul #b000000000110 X6)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b000000000011 X2)  #b000000000001) #b000000000000))
