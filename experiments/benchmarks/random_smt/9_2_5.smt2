...
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b000000000011 X1) (bvmul #b111111110111 X2) (bvmul #b000000000101 X4) (bvmul #b111111111010 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X6)  #b000000000100) #b000000000000))
