...
(assert (bvsge (bvadd (bvmul #b111111110111 X2) (bvmul #b111111111111 X8) (bvmul #b111111110111 X9)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X11) (bvmul #b000000001001 X12) (bvmul #b111111110110 X13)  #b000000000110) #b000000000000))
