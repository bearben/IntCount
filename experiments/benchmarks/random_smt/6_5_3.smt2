...
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b111111110110 X3) (bvmul #b000000000111 X5)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X2) (bvmul #b111111111000 X4)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b000000000110 X3) (bvmul #b111111111010 X4)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111111 X1) (bvmul #b111111111001 X5)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111110110 X1) (bvmul #b000000000011 X4)  #b111111111000) #b000000000000))
