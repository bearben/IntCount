...
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000001001 X3) (bvmul #b000000001010 X8) (bvmul #b000000000110 X9)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X3)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b000000001001 X4)  #b000000000010) #b000000000000))
