...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111110111 X1) (bvmul #b000000000110 X2) (bvmul #b000000001000 X3) (bvmul #b111111110110 X4) (bvmul #b111111111100 X5) (bvmul #b000000000111 X6) (bvmul #b111111111110 X7) (bvmul #b000000001001 X8) (bvmul #b000000000101 X9)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111110 X1) (bvmul #b000000001000 X2) (bvmul #b000000001010 X3) (bvmul #b111111111001 X6) (bvmul #b000000000111 X7) (bvmul #b111111111000 X8) (bvmul #b000000001000 X9)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111111010 X1) (bvmul #b111111111111 X3) (bvmul #b111111111111 X4) (bvmul #b111111110111 X6) (bvmul #b111111110110 X7) (bvmul #b000000000011 X8) (bvmul #b000000000001 X9)  #b111111111110) #b000000000000))
