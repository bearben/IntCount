...
(assert (bvsge (bvadd (bvmul #b000000000011 X1) (bvmul #b000000001010 X2) (bvmul #b111111110110 X3) (bvmul #b111111111101 X4) (bvmul #b111111111000 X5) (bvmul #b000000000110 X6) (bvmul #b000000001001 X7) (bvmul #b000000001000 X8) (bvmul #b111111110111 X9) (bvmul #b111111110110 X11) (bvmul #b000000001010 X12)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X1) (bvmul #b000000000001 X2)  #b000000000000) #b000000000000))
