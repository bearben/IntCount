...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000001000 X1) (bvmul #b111111111000 X2) (bvmul #b000000000101 X3) (bvmul #b000000000101 X4) (bvmul #b111111111100 X5) (bvmul #b111111111011 X6) (bvmul #b000000000101 X7) (bvmul #b000000001010 X8) (bvmul #b111111110111 X9) (bvmul #b111111111111 X10)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111110110 X1) (bvmul #b111111111011 X2) (bvmul #b000000000001 X6) (bvmul #b111111111111 X8) (bvmul #b111111111111 X9)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000000001 X7)  #b111111111100) #b000000000000))
