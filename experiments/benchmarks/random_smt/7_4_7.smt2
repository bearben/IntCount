...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111111 X1) (bvmul #b000000000111 X2) (bvmul #b111111111101 X3) (bvmul #b111111111010 X4) (bvmul #b111111111101 X5) (bvmul #b000000000100 X6)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000000011 X4) (bvmul #b000000000010 X5) (bvmul #b111111111100 X6)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111111111 X2) (bvmul #b111111111000 X5) (bvmul #b000000001000 X6)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b000000001001 X1) (bvmul #b111111111100 X3) (bvmul #b111111111100 X4) (bvmul #b111111111010 X5)  #b111111111011) #b000000000000))
