...
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000010 X4) (bvmul #b000000001001 X5) (bvmul #b000000000101 X8)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1) (bvmul #b111111111110 X4) (bvmul #b111111110110 X5) (bvmul #b000000000111 X8)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b000000000111 X4) (bvmul #b000000000011 X6)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X5) (bvmul #b000000000010 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X8)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b000000001001 X2)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X4) (bvmul #b111111110110 X7) (bvmul #b111111111011 X8)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X3) (bvmul #b111111111101 X5)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X2) (bvmul #b111111111100 X5) (bvmul #b111111110110 X6)  #b111111111110) #b000000000000))
