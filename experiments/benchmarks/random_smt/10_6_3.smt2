...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b000000001000 X5) (bvmul #b111111110111 X6)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111111 X1) (bvmul #b111111111111 X3)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X3) (bvmul #b000000000011 X4)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000001010 X4) (bvmul #b000000000011 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111011 X9)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X2) (bvmul #b000000001000 X5)  #b111111110111) #b000000000000))
