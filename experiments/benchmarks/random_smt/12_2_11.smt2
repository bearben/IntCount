...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000001 X2) (bvmul #b000000001001 X3) (bvmul #b000000001000 X4) (bvmul #b000000000011 X5) (bvmul #b000000001010 X6) (bvmul #b111111111100 X7) (bvmul #b000000000110 X8) (bvmul #b111111111011 X9) (bvmul #b000000000011 X10) (bvmul #b111111111001 X11)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X7)  #b111111111100) #b000000000000))
