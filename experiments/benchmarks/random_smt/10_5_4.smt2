...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111011 X2) (bvmul #b000000001010 X5) (bvmul #b111111111010 X7)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111010 X4) (bvmul #b000000000011 X8) (bvmul #b111111111101 X9)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b000000000011 X3) (bvmul #b000000000011 X7) (bvmul #b111111110111 X8)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3) (bvmul #b111111111001 X6) (bvmul #b000000000101 X7)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X1) (bvmul #b000000000010 X3) (bvmul #b000000001000 X6) (bvmul #b111111110111 X9)  #b000000000110) #b000000000000))
