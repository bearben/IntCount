...
(assert (bvsge (bvadd (bvmul #b111111111011 X7)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X2)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X7)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X8)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3)  #b000000000000) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b000000000100 X1)  #b111111111111) #b000000000000))
