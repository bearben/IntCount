...
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b000000000101 X2) (bvmul #b111111110111 X5)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b000000000011 X2)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X4) (bvmul #b000000000001 X7) (bvmul #b000000001001 X8)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111110111 X4) (bvmul #b000000000100 X9)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X2) (bvmul #b111111110111 X7) (bvmul #b000000001001 X8)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111011 X3)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b111111111100 X2) (bvmul #b111111111000 X6)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X2) (bvmul #b111111111100 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X4) (bvmul #b000000001001 X8) (bvmul #b000000000100 X9)  #b111111111001) #b000000000000))
