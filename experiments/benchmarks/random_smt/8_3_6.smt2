...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111110110 X1) (bvmul #b111111110111 X3) (bvmul #b111111110110 X4) (bvmul #b000000001001 X6) (bvmul #b111111111000 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X6) (bvmul #b111111111101 X7)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X2) (bvmul #b000000001010 X3) (bvmul #b111111110110 X4) (bvmul #b111111111010 X6) (bvmul #b000000001001 X7)  #b111111111110) #b000000000000))
