...
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b000000001000 X11)  #b000000000001) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b000000000001 X3) (bvmul #b000000000100 X6)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1)  #b000000000001) #b000000000000))
