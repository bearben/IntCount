...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111010 X2) (bvmul #b111111111100 X3) (bvmul #b111111111110 X4) (bvmul #b111111111100 X5) (bvmul #b000000000011 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000001 X2) (bvmul #b000000001000 X5) (bvmul #b111111111000 X6) (bvmul #b111111110110 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b111111110111 X3) (bvmul #b000000000011 X5)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000000010 X3)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000010 X2) (bvmul #b111111110111 X7)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X2) (bvmul #b111111110110 X3) (bvmul #b111111111011 X4) (bvmul #b000000000011 X5) (bvmul #b000000000011 X6)  #b000000000110) #b000000000000))
