...
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111011 X1) (bvmul #b000000000010 X3)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b000000000110 X2)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X1) (bvmul #b111111111010 X4)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0)  #b111111111011) #b000000000000))
