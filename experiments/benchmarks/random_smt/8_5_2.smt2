...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000110 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X6)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X4) (bvmul #b111111111100 X5)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X5) (bvmul #b000000000110 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X0) (bvmul #b111111111110 X2)  #b111111111110) #b000000000000))
