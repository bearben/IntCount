...
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000001001 X3) (bvmul #b000000000110 X4)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X3)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X9)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000110 X8)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b111111111011 X6)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X8)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X2) (bvmul #b111111111100 X3) (bvmul #b111111110111 X10)  #b000000001000) #b000000000000))
