...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111111 X1) (bvmul #b111111111110 X2) (bvmul #b111111110111 X3) (bvmul #b111111111110 X4) (bvmul #b111111111100 X5) (bvmul #b000000000101 X6) (bvmul #b111111111100 X7)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b111111111100 X1) (bvmul #b000000001001 X2) (bvmul #b000000001001 X3) (bvmul #b111111111111 X4) (bvmul #b111111111101 X5) (bvmul #b111111111011 X6) (bvmul #b000000000011 X7)  #b111111111011) #b000000000000))
