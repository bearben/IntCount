...
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b000000000100 X2) (bvmul #b111111111011 X3) (bvmul #b111111111010 X5) (bvmul #b000000001000 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b000000000111 X2) (bvmul #b111111110110 X4) (bvmul #b000000000111 X5)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b111111110111 X1) (bvmul #b111111111101 X3) (bvmul #b111111111001 X4) (bvmul #b000000000010 X6)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X2) (bvmul #b000000000111 X3) (bvmul #b111111110110 X6) (bvmul #b111111111111 X7)  #b000000000110) #b000000000000))
