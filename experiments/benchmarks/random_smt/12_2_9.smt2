...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000100 X1) (bvmul #b111111111100 X2) (bvmul #b111111111101 X3) (bvmul #b000000001010 X4) (bvmul #b000000001010 X5) (bvmul #b111111111101 X6) (bvmul #b000000000010 X8) (bvmul #b111111111011 X11)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X2) (bvmul #b111111111111 X3) (bvmul #b111111111000 X4) (bvmul #b000000000001 X5) (bvmul #b111111111111 X6) (bvmul #b000000001000 X7) (bvmul #b000000000011 X8) (bvmul #b111111111000 X9) (bvmul #b111111111000 X10)  #b111111111000) #b000000000000))
