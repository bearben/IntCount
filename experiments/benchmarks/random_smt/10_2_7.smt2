...
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000100 X2) (bvmul #b000000000111 X3) (bvmul #b111111110111 X5) (bvmul #b111111111110 X6) (bvmul #b111111111011 X8) (bvmul #b000000000101 X9)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b000000000010 X2) (bvmul #b000000000001 X3) (bvmul #b111111111101 X4) (bvmul #b111111111001 X5) (bvmul #b111111111001 X6)  #b000000000000) #b000000000000))
