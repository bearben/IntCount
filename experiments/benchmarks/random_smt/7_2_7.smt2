...
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111111110 X1) (bvmul #b111111110111 X2) (bvmul #b111111110110 X3) (bvmul #b111111110110 X4) (bvmul #b111111111110 X5) (bvmul #b111111111000 X6)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X3) (bvmul #b111111111111 X4)  #b000000000100) #b000000000000))
