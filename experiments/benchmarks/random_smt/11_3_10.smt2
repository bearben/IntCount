...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111110110 X1) (bvmul #b111111110110 X3) (bvmul #b000000000100 X4) (bvmul #b111111111001 X5) (bvmul #b000000001001 X6) (bvmul #b000000000100 X7) (bvmul #b000000000011 X8) (bvmul #b000000000101 X9) (bvmul #b000000000111 X10)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000011 X1) (bvmul #b000000000001 X4) (bvmul #b111111111110 X8) (bvmul #b000000000101 X9) (bvmul #b111111111000 X10)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111101 X4) (bvmul #b111111111000 X5)  #b111111110110) #b000000000000))
