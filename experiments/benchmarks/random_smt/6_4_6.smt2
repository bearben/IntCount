...
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b111111111001 X1) (bvmul #b000000000010 X2) (bvmul #b111111111101 X3) (bvmul #b000000000001 X4) (bvmul #b111111111100 X5)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b000000000100 X1) (bvmul #b111111111111 X2) (bvmul #b000000001010 X3) (bvmul #b111111111111 X4) (bvmul #b000000000011 X5)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111111100 X1) (bvmul #b111111110110 X2) (bvmul #b111111111110 X3) (bvmul #b000000000111 X4) (bvmul #b000000001010 X5)  #b000000000100) #b000000000000))
