...
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b111111110111 X3) (bvmul #b000000001001 X4) (bvmul #b111111111011 X5) (bvmul #b000000000100 X7) (bvmul #b111111111110 X8)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X2) (bvmul #b111111111010 X6) (bvmul #b000000001001 X7) (bvmul #b111111111101 X9)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X3) (bvmul #b111111111110 X5) (bvmul #b111111111100 X8)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b000000000010 X7)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X3) (bvmul #b000000000111 X5) (bvmul #b000000001001 X6) (bvmul #b111111111111 X7) (bvmul #b111111110110 X9)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111111100 X4)  #b000000001000) #b000000000000))
