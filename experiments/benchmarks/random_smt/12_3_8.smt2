...
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b000000000100 X2) (bvmul #b000000000001 X4) (bvmul #b000000000011 X5) (bvmul #b000000000111 X6) (bvmul #b111111111001 X7) (bvmul #b111111111101 X8) (bvmul #b111111111011 X11)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X3) (bvmul #b111111110111 X5)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b000000000001 X2) (bvmul #b000000000011 X6) (bvmul #b000000000100 X8) (bvmul #b000000001000 X9)  #b000000001010) #b000000000000))
