...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b000000001000 X5)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111111 X4)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X2)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X5) (bvmul #b111111110110 X6)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000010 X7)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X2)  #b111111111110) #b000000000000))
