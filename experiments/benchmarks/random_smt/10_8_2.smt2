...
(assert (bvsge (bvadd (bvmul #b000000000001 X4) (bvmul #b000000000010 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X3)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111010 X4)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b000000000100 X9)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X4) (bvmul #b000000000111 X5)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X9)  #b000000000000) #b000000000000))
