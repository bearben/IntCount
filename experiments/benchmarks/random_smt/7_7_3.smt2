...
(assert (bvsge (bvadd (bvmul #b111111110110 X3) (bvmul #b000000000100 X4) (bvmul #b111111111111 X5)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3) (bvmul #b000000000011 X5) (bvmul #b111111111001 X6)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X6)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111100 X1) (bvmul #b111111111111 X5)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X2)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X2) (bvmul #b000000000100 X6)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b111111110110 X3) (bvmul #b111111111000 X5)  #b000000001010) #b000000000000))
