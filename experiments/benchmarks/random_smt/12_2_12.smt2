...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b111111111011 X1) (bvmul #b000000000001 X2) (bvmul #b111111110110 X3) (bvmul #b111111111111 X4) (bvmul #b111111111110 X5) (bvmul #b000000000110 X6) (bvmul #b111111111000 X7) (bvmul #b111111111010 X8) (bvmul #b111111111111 X9) (bvmul #b000000000001 X10) (bvmul #b000000001000 X11)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X2) (bvmul #b000000000011 X3) (bvmul #b000000001010 X4) (bvmul #b000000000110 X6) (bvmul #b111111111101 X10) (bvmul #b111111111001 X11)  #b111111111010) #b000000000000))
