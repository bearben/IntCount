...
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000000001 X1) (bvmul #b000000000011 X2) (bvmul #b111111111011 X3) (bvmul #b111111111011 X4) (bvmul #b000000000001 X5) (bvmul #b111111111101 X6) (bvmul #b000000001000 X7) (bvmul #b000000000110 X8)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000001001 X2) (bvmul #b000000000100 X3) (bvmul #b000000001010 X4) (bvmul #b111111110110 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111111100 X1) (bvmul #b000000000101 X2) (bvmul #b111111110110 X3) (bvmul #b111111111011 X4) (bvmul #b000000000010 X5) (bvmul #b111111111101 X6) (bvmul #b000000000111 X8)  #b111111111000) #b000000000000))
