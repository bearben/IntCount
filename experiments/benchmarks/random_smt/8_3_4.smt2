...
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b111111111110 X4) (bvmul #b000000000100 X5) (bvmul #b000000001001 X6)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X5)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X4)  #b000000000000) #b000000000000))
