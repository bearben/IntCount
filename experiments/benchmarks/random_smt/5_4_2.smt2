...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111101 X3)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b000000000001 X3)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X2) (bvmul #b000000001000 X4)  #b000000000011) #b000000000000))
