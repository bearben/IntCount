...
(assert (bvsge (bvadd (bvmul #b000000000010 X3)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X7)  #b111111111110) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b111111111110 X1)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X2)  #b111111111000) #b000000000000))
