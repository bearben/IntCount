...
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b000000000011 X1) (bvmul #b000000000111 X3) (bvmul #b111111111100 X4) (bvmul #b111111111011 X5) (bvmul #b000000001010 X6) (bvmul #b000000000010 X7)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b000000000111 X2) (bvmul #b111111111000 X6)  #b000000001000) #b000000000000))
