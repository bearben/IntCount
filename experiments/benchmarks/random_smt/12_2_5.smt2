...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111011 X6) (bvmul #b000000000010 X7) (bvmul #b111111110110 X8) (bvmul #b111111111000 X10)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b111111110110 X2) (bvmul #b111111110111 X9) (bvmul #b000000000011 X11)  #b111111110111) #b000000000000))
