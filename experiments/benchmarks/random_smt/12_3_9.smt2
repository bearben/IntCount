...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000010 X1) (bvmul #b000000000010 X2) (bvmul #b111111111010 X4) (bvmul #b000000000010 X5) (bvmul #b000000000100 X6) (bvmul #b000000000110 X8) (bvmul #b111111111010 X10) (bvmul #b111111111000 X11)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111110110 X6) (bvmul #b111111110110 X8)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X4) (bvmul #b000000000011 X8)  #b111111111011) #b000000000000))
