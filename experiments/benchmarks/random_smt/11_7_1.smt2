...
(assert (bvsge (bvadd (bvmul #b000000000110 X2)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X6)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X0)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X6)  #b000000001010) #b000000000000))
