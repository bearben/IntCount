...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111011 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X5)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X2) (bvmul #b000000000011 X4)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X1)  #b111111111111) #b000000000000))
