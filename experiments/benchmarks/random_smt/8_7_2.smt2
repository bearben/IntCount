...
(assert (bvsge (bvadd (bvmul #b000000001000 X5) (bvmul #b111111111100 X6)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X4) (bvmul #b000000001001 X6)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X5)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b000000001010 X3)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X3)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X2)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111000 X4)  #b000000000010) #b000000000000))
