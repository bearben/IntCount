...
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111100 X6) (bvmul #b000000001010 X8) (bvmul #b000000001001 X9) (bvmul #b111111111000 X10) (bvmul #b111111111111 X11)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X6) (bvmul #b111111111011 X7) (bvmul #b000000000010 X12)  #b000000000001) #b000000000000))
