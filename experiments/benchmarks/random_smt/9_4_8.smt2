...
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000001010 X1) (bvmul #b111111111101 X2) (bvmul #b000000001000 X3) (bvmul #b000000001001 X4) (bvmul #b000000001000 X6) (bvmul #b111111110110 X7) (bvmul #b111111111101 X8)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X3)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X3) (bvmul #b111111111001 X5)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111111 X1) (bvmul #b111111111101 X2) (bvmul #b111111111101 X3) (bvmul #b000000001010 X4) (bvmul #b000000001000 X5) (bvmul #b000000001010 X6) (bvmul #b111111111100 X7)  #b000000001010) #b000000000000))
