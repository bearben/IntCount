...
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000110 X3) (bvmul #b000000001000 X4) (bvmul #b111111111000 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X5) (bvmul #b000000000010 X8)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X6)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b111111110111 X4) (bvmul #b111111110110 X5) (bvmul #b000000000010 X6)  #b000000001000) #b000000000000))
