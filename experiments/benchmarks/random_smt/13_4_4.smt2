...
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b000000000101 X2) (bvmul #b111111111000 X6) (bvmul #b111111111010 X12)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X7) (bvmul #b000000000111 X10)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b000000001001 X4) (bvmul #b111111111101 X6)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X3) (bvmul #b111111111011 X6) (bvmul #b000000000111 X10)  #b000000000010) #b000000000000))
