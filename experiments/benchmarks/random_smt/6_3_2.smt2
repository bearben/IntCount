...
(assert (bvsge (bvadd (bvmul #b000000000011 X2) (bvmul #b000000000111 X5)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X3)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X2) (bvmul #b000000000100 X4)  #b000000001000) #b000000000000))
