...
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b111111110110 X1) (bvmul #b111111110111 X2) (bvmul #b111111110110 X6) (bvmul #b000000000110 X7) (bvmul #b000000000010 X8) (bvmul #b000000000111 X10)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X1)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b000000000001 X1) (bvmul #b000000000001 X2) (bvmul #b000000000001 X4) (bvmul #b000000000110 X5) (bvmul #b111111111010 X9)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111010 X1) (bvmul #b000000000010 X3) (bvmul #b000000000010 X7)  #b111111111101) #b000000000000))
