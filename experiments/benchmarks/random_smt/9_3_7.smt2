...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111001 X1) (bvmul #b000000000110 X2) (bvmul #b000000001010 X4) (bvmul #b000000000011 X5) (bvmul #b000000001001 X7) (bvmul #b111111110111 X8)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X0) (bvmul #b000000000101 X2) (bvmul #b111111111110 X3) (bvmul #b000000000011 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1) (bvmul #b000000000010 X2)  #b000000000011) #b000000000000))
