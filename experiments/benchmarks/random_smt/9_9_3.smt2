...
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b000000001001 X2) (bvmul #b000000001001 X3)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111001 X1) (bvmul #b000000000011 X5)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b000000000010 X3) (bvmul #b111111111011 X4)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X2) (bvmul #b000000001000 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X7)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X2) (bvmul #b000000001000 X3) (bvmul #b111111111001 X5)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111000 X8)  #b000000000010) #b000000000000))
