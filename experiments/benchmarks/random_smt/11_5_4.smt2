...
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000011 X1) (bvmul #b000000001010 X2) (bvmul #b111111111011 X4)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X2) (bvmul #b111111111101 X5)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X3) (bvmul #b111111111000 X7) (bvmul #b000000000101 X10)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b111111111100 X1) (bvmul #b111111111011 X2) (bvmul #b000000000001 X8)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X6)  #b000000000111) #b000000000000))
