...
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000101 X8)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X7)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X3) (bvmul #b111111111111 X10)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b000000000101 X3)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X5) (bvmul #b111111111111 X7)  #b000000000001) #b000000000000))
