...
(assert (bvsge (bvadd (bvmul #b111111111010 X1) (bvmul #b111111111010 X12)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X6)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X3) (bvmul #b111111110110 X10)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X3)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111111 X11)  #b111111111111) #b000000000000))
