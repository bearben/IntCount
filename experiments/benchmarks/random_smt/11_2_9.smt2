...
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111001 X1) (bvmul #b000000001001 X2) (bvmul #b000000001010 X4) (bvmul #b000000000011 X5) (bvmul #b000000000010 X6) (bvmul #b000000000010 X8) (bvmul #b000000000011 X9) (bvmul #b000000001000 X10)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111110 X2) (bvmul #b111111111010 X4) (bvmul #b000000000011 X6) (bvmul #b111111111111 X9)  #b000000000111) #b000000000000))
