...
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111000 X3) (bvmul #b111111110111 X4) (bvmul #b111111111111 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111110111 X3)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X8)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111111 X3) (bvmul #b000000000010 X4) (bvmul #b000000000010 X6)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X4) (bvmul #b111111111100 X7)  #b000000001001) #b000000000000))
