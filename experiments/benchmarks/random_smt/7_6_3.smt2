...
(assert (bvsge (bvadd (bvmul #b111111111110 X3) (bvmul #b000000000110 X5) (bvmul #b000000000010 X6)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X2) (bvmul #b000000000010 X3) (bvmul #b111111110110 X5)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111111 X3) (bvmul #b000000000010 X6)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111110110 X1) (bvmul #b000000000110 X2)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b111111111011 X1) (bvmul #b000000001010 X3)  #b000000001000) #b000000000000))
