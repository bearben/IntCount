...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111111 X3) (bvmul #b000000001000 X4) (bvmul #b111111111010 X5) (bvmul #b111111111010 X6) (bvmul #b000000000111 X7) (bvmul #b000000001010 X10)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X9)  #b111111111011) #b000000000000))
