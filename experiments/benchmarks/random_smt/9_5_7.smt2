...
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b000000000001 X2) (bvmul #b000000001001 X3) (bvmul #b000000000100 X4) (bvmul #b111111111111 X5) (bvmul #b111111111111 X6) (bvmul #b111111111111 X7)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000010 X1) (bvmul #b000000001001 X3) (bvmul #b000000000110 X4) (bvmul #b111111111100 X5) (bvmul #b000000000011 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111110110 X2) (bvmul #b000000000010 X3) (bvmul #b000000001010 X4) (bvmul #b111111111100 X5) (bvmul #b111111111111 X6) (bvmul #b111111111010 X8)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000100 X2) (bvmul #b000000001010 X4) (bvmul #b000000000100 X5) (bvmul #b111111111111 X7) (bvmul #b111111111010 X8)  #b111111111001) #b000000000000))
