...
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111111101 X2) (bvmul #b000000001010 X5) (bvmul #b111111110110 X7) (bvmul #b111111110110 X9) (bvmul #b111111111110 X10)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X2) (bvmul #b111111111010 X5) (bvmul #b000000000101 X8) (bvmul #b111111111111 X10) (bvmul #b000000000110 X11)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b000000001000 X3) (bvmul #b111111111101 X5) (bvmul #b111111111110 X6) (bvmul #b000000000010 X9) (bvmul #b000000000101 X10)  #b000000001000) #b000000000000))
