...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111001 X1) (bvmul #b111111111111 X2) (bvmul #b111111111011 X3) (bvmul #b111111111000 X4) (bvmul #b111111110110 X6) (bvmul #b000000000110 X8) (bvmul #b111111111010 X10) (bvmul #b000000000101 X11) (bvmul #b111111111001 X12)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b000000001001 X2) (bvmul #b000000000111 X6) (bvmul #b111111111001 X8) (bvmul #b111111111110 X9) (bvmul #b111111111000 X12)  #b000000001010) #b000000000000))
