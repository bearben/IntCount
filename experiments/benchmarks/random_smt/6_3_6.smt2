...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000100 X1) (bvmul #b000000000100 X2) (bvmul #b000000000011 X3) (bvmul #b000000000100 X4) (bvmul #b111111111101 X5)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X2)  #b111111111101) #b000000000000))
