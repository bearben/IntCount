...
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b000000000100 X3) (bvmul #b000000001000 X4) (bvmul #b000000000101 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111110110 X1) (bvmul #b111111111010 X2) (bvmul #b111111110110 X6)  #b111111111011) #b000000000000))
