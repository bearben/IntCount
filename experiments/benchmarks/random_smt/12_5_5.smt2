...
(assert (bvsge (bvadd (bvmul #b000000000001 X0) (bvmul #b000000000011 X2) (bvmul #b000000000011 X3) (bvmul #b000000000101 X6) (bvmul #b111111111110 X10)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X10)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111110110 X10)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000000110 X4) (bvmul #b000000000111 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b111111111111 X2) (bvmul #b000000001010 X4) (bvmul #b111111111010 X9) (bvmul #b111111111111 X10)  #b111111111110) #b000000000000))
