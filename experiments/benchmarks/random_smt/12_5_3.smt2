...
(assert (bvsge (bvadd (bvmul #b000000000100 X2) (bvmul #b000000000111 X3) (bvmul #b000000000110 X11)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X4) (bvmul #b111111111001 X7)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X3) (bvmul #b000000000010 X6) (bvmul #b111111111000 X11)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111111 X4) (bvmul #b000000000100 X7)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X7) (bvmul #b000000001000 X8)  #b111111111000) #b000000000000))
