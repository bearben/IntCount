...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b111111111001 X4) (bvmul #b000000001001 X6) (bvmul #b000000000101 X7) (bvmul #b000000000110 X9)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111011 X1) (bvmul #b000000000001 X6) (bvmul #b000000000111 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X3) (bvmul #b111111111100 X4) (bvmul #b111111111001 X5)  #b111111111111) #b000000000000))
