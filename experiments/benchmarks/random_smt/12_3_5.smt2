...
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b000000000111 X2) (bvmul #b111111111110 X7) (bvmul #b000000000101 X9) (bvmul #b000000000101 X11)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X2) (bvmul #b111111111010 X4) (bvmul #b111111111000 X10)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X6) (bvmul #b111111111011 X7) (bvmul #b000000000111 X11)  #b000000000111) #b000000000000))
