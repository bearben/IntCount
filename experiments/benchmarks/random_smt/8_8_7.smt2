...
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111110111 X1) (bvmul #b000000000100 X2) (bvmul #b000000001001 X3) (bvmul #b111111111011 X5) (bvmul #b111111111010 X6) (bvmul #b000000001001 X7)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000000011 X1) (bvmul #b000000000010 X2) (bvmul #b000000001000 X3) (bvmul #b000000000011 X4) (bvmul #b000000000011 X6) (bvmul #b111111111001 X7)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111000 X1) (bvmul #b111111111111 X3) (bvmul #b111111111000 X4) (bvmul #b111111111010 X6)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X2) (bvmul #b111111111111 X3) (bvmul #b000000000101 X4) (bvmul #b111111111010 X5) (bvmul #b000000000100 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111101 X1) (bvmul #b111111111001 X2) (bvmul #b111111111111 X6) (bvmul #b111111111000 X7)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b111111111000 X2) (bvmul #b111111111010 X4) (bvmul #b000000001000 X6)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X2) (bvmul #b000000001001 X4) (bvmul #b111111111010 X7)  #b111111111010) #b000000000000))
