...
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111110110 X2) (bvmul #b111111110110 X3) (bvmul #b111111111101 X4) (bvmul #b000000001010 X5) (bvmul #b000000001000 X6) (bvmul #b000000001001 X7) (bvmul #b000000000101 X8)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000000010 X1) (bvmul #b000000001010 X2) (bvmul #b111111111000 X4) (bvmul #b111111111010 X5) (bvmul #b000000001001 X6) (bvmul #b000000000011 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000011 X1) (bvmul #b111111111101 X2) (bvmul #b000000000001 X3) (bvmul #b000000000110 X5) (bvmul #b000000001001 X6) (bvmul #b111111111011 X7) (bvmul #b000000001010 X8)  #b111111111110) #b000000000000))
