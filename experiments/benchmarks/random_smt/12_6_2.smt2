...
(assert (bvsge (bvadd (bvmul #b000000001010 X2) (bvmul #b111111111110 X6)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000110 X10)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X8)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X2) (bvmul #b000000000011 X3)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X1)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X4)  #b111111111010) #b000000000000))
