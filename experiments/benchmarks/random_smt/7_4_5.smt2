...
(assert (bvsge (bvadd (bvmul #b111111111010 X1) (bvmul #b000000000111 X2) (bvmul #b000000000010 X3) (bvmul #b000000000101 X5) (bvmul #b111111110111 X6)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X1) (bvmul #b000000000010 X4)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b111111111001 X4)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X1)  #b111111111000) #b000000000000))
