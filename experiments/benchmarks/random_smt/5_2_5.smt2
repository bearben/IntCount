...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000010 X1) (bvmul #b000000000101 X2) (bvmul #b000000000010 X3) (bvmul #b111111111101 X4)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0)  #b000000000111) #b000000000000))
