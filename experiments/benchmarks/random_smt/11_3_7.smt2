...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000001000 X1) (bvmul #b000000000110 X2) (bvmul #b000000000111 X3) (bvmul #b111111111100 X4) (bvmul #b111111110111 X8) (bvmul #b111111111110 X10)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111111111 X2) (bvmul #b000000000011 X3) (bvmul #b111111111010 X5) (bvmul #b000000000010 X9)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X5) (bvmul #b000000000001 X7)  #b111111110110) #b000000000000))
