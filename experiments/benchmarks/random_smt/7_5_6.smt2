...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000111 X1) (bvmul #b000000000100 X2) (bvmul #b111111110111 X3) (bvmul #b111111111101 X5) (bvmul #b000000000101 X6)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b111111111100 X5)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000001001 X2)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000001010 X4) (bvmul #b111111111011 X5) (bvmul #b111111111011 X6)  #b111111111110) #b000000000000))
