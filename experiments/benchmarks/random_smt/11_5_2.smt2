...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000001 X1)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000000001 X4)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000101 X5)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b000000000111 X6)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X5) (bvmul #b000000000010 X10)  #b000000000101) #b000000000000))
