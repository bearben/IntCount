...
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b000000001001 X5) (bvmul #b111111111010 X6)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X7)  #b000000000111) #b000000000000))
