...
(assert (bvsge (bvadd (bvmul #b111111111111 X3)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X7)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X5)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X3)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X2)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X1)  #b000000000000) #b000000000000))
