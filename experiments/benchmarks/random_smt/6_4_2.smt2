...
(assert (bvsge (bvadd (bvmul #b111111111001 X3) (bvmul #b000000000110 X4)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X1) (bvmul #b111111110111 X5)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X4)  #b111111111111) #b000000000000))
