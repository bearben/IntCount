...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111100 X3) (bvmul #b000000000101 X5)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b000000000011 X2) (bvmul #b111111111101 X7)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111100 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X3) (bvmul #b111111110111 X4)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X2) (bvmul #b111111111111 X6)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X3) (bvmul #b111111111000 X4)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b000000000001 X3) (bvmul #b111111111011 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X4) (bvmul #b000000001010 X5) (bvmul #b000000000111 X6)  #b111111111010) #b000000000000))
