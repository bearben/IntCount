...
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b111111111010 X4) (bvmul #b111111110111 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1) (bvmul #b000000001001 X8) (bvmul #b000000001000 X9)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X3)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b000000000100 X4) (bvmul #b111111111010 X9)  #b000000001001) #b000000000000))
