...
(assert (bvsge (bvadd (bvmul #b111111111010 X3)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X4)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0)  #b111111111000) #b000000000000))
