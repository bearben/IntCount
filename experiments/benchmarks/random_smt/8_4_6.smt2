...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111001 X1) (bvmul #b111111111001 X2) (bvmul #b111111111101 X5) (bvmul #b000000000010 X6) (bvmul #b000000000111 X7)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X1) (bvmul #b111111111011 X2) (bvmul #b111111111011 X3) (bvmul #b111111111011 X6) (bvmul #b000000001001 X7)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b000000000110 X2) (bvmul #b111111111011 X3) (bvmul #b000000000111 X4) (bvmul #b111111111001 X5) (bvmul #b111111111111 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000010 X3) (bvmul #b111111110110 X6) (bvmul #b000000001010 X7)  #b111111111111) #b000000000000))
