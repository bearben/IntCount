...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000001001 X1) (bvmul #b000000001000 X2) (bvmul #b000000000010 X3) (bvmul #b111111110110 X4) (bvmul #b000000001010 X5) (bvmul #b000000001001 X6) (bvmul #b000000001001 X7) (bvmul #b111111110110 X8) (bvmul #b000000000011 X9) (bvmul #b111111111010 X10)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b000000000110 X3) (bvmul #b000000000111 X4) (bvmul #b000000001001 X6) (bvmul #b000000001000 X8) (bvmul #b111111111110 X9) (bvmul #b111111111101 X10)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b000000001000 X2) (bvmul #b111111111001 X5) (bvmul #b000000000110 X6) (bvmul #b000000000001 X7) (bvmul #b000000000100 X10)  #b111111111111) #b000000000000))
