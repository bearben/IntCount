...
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b000000000111 X3) (bvmul #b111111111011 X4) (bvmul #b000000000100 X7) (bvmul #b111111111101 X8)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b000000000001 X2) (bvmul #b000000000111 X3) (bvmul #b000000000011 X4) (bvmul #b111111111101 X8)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1) (bvmul #b000000000111 X4) (bvmul #b111111111001 X5) (bvmul #b000000000101 X7)  #b111111110110) #b000000000000))
