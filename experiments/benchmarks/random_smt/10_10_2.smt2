...
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b111111111110 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X4)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b111111111001 X2)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X7) (bvmul #b000000000010 X8)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X7)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X2) (bvmul #b111111111011 X4)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111111001 X8)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X7) (bvmul #b000000000110 X8)  #b000000001010) #b000000000000))
