...
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111010 X1) (bvmul #b111111111110 X2) (bvmul #b111111111100 X3) (bvmul #b000000000111 X4) (bvmul #b000000000111 X5) (bvmul #b111111111011 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111110111 X2) (bvmul #b000000000001 X5)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111110110 X1) (bvmul #b000000001001 X2) (bvmul #b111111110110 X4) (bvmul #b111111111101 X5) (bvmul #b111111111110 X6) (bvmul #b111111111110 X7)  #b111111110110) #b000000000000))
