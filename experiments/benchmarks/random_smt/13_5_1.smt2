...
(assert (bvsge (bvadd (bvmul #b111111111010 X10)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X2)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X10)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X7)  #b111111110111) #b000000000000))
