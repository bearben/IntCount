...
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111110110 X1) (bvmul #b111111110111 X2) (bvmul #b000000001000 X3) (bvmul #b111111111100 X4)  #b111111111110) #b000000000000))
