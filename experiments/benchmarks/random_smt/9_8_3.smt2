...
(assert (bvsge (bvadd (bvmul #b000000001010 X2) (bvmul #b000000000010 X3) (bvmul #b000000000010 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X2) (bvmul #b111111111110 X7) (bvmul #b111111111110 X8)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1) (bvmul #b000000000111 X5) (bvmul #b000000000100 X8)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X4)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X2)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X4) (bvmul #b111111110111 X5) (bvmul #b000000000010 X8)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1) (bvmul #b000000001010 X5) (bvmul #b000000001010 X7)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111011 X5)  #b000000000000) #b000000000000))
