...
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111110111 X5) (bvmul #b111111111100 X6) (bvmul #b000000001000 X7)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b000000000010 X4)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X2) (bvmul #b000000000101 X6) (bvmul #b000000001010 X8) (bvmul #b111111111110 X10)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X4) (bvmul #b111111110111 X10)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X7) (bvmul #b111111111100 X8) (bvmul #b111111111111 X9) (bvmul #b111111111000 X10)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X5) (bvmul #b000000000101 X10)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X8)  #b000000000001) #b000000000000))
