...
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b111111111110 X2) (bvmul #b111111111011 X3) (bvmul #b000000001000 X4) (bvmul #b000000000010 X7) (bvmul #b000000000010 X8)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000000101 X1) (bvmul #b000000000001 X5) (bvmul #b111111111110 X8) (bvmul #b000000001000 X9)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X4) (bvmul #b000000000001 X5) (bvmul #b111111110111 X9)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X1) (bvmul #b000000000111 X3) (bvmul #b000000001001 X9)  #b000000000010) #b000000000000))
