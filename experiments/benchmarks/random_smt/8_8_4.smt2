...
(assert (bvsge (bvadd (bvmul #b000000000111 X2) (bvmul #b000000000010 X4) (bvmul #b000000000110 X5) (bvmul #b111111111101 X7)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111111 X4) (bvmul #b000000000110 X5) (bvmul #b000000001001 X6)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X2)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X1)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X2) (bvmul #b000000001001 X5) (bvmul #b000000000110 X6)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000001010 X3) (bvmul #b000000000110 X4) (bvmul #b000000000101 X6)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111101 X1)  #b000000000101) #b000000000000))
