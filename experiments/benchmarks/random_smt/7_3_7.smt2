...
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b111111111000 X1) (bvmul #b000000000001 X2) (bvmul #b111111111100 X3) (bvmul #b111111111100 X4) (bvmul #b111111110111 X5) (bvmul #b000000001010 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b000000001010 X1) (bvmul #b000000000111 X2) (bvmul #b111111110110 X3) (bvmul #b000000000001 X4) (bvmul #b111111111100 X5) (bvmul #b111111111001 X6)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X2) (bvmul #b111111111000 X5) (bvmul #b000000001010 X6)  #b000000000010) #b000000000000))
