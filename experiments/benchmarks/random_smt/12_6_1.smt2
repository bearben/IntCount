...
(assert (bvsge (bvadd (bvmul #b000000000100 X5)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X0)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X5)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X8)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X9)  #b000000001000) #b000000000000))
