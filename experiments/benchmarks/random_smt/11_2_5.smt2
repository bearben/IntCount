...
(assert (bvsge (bvadd (bvmul #b000000000010 X4) (bvmul #b000000000101 X5) (bvmul #b000000001010 X7) (bvmul #b111111111100 X8) (bvmul #b000000000101 X10)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X4) (bvmul #b111111110110 X10)  #b111111111010) #b000000000000))
