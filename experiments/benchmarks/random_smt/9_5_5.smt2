...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000111 X1) (bvmul #b111111111101 X3) (bvmul #b111111111011 X5) (bvmul #b000000000111 X8)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111101 X7)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X3) (bvmul #b000000000101 X4) (bvmul #b111111110110 X6) (bvmul #b000000000010 X7) (bvmul #b111111111100 X8)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111110110 X2)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b000000000110 X4) (bvmul #b000000001001 X7) (bvmul #b111111111111 X8)  #b111111111110) #b000000000000))
