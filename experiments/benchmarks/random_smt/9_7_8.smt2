...
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b111111110110 X1) (bvmul #b111111111001 X2) (bvmul #b000000001000 X4) (bvmul #b111111111010 X5) (bvmul #b111111111011 X6) (bvmul #b111111110111 X7) (bvmul #b000000000101 X8)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b000000001001 X6)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X3) (bvmul #b111111111001 X4) (bvmul #b000000000101 X6)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X7)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111110 X2) (bvmul #b000000000100 X3) (bvmul #b000000000101 X4) (bvmul #b111111111110 X5) (bvmul #b111111111011 X6) (bvmul #b000000000101 X7) (bvmul #b000000001010 X8)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b000000000111 X1) (bvmul #b000000000100 X2) (bvmul #b111111111011 X5)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b111111110110 X3) (bvmul #b111111111101 X4) (bvmul #b111111111000 X6) (bvmul #b000000000101 X7)  #b000000000110) #b000000000000))
