...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b000000000111 X2) (bvmul #b000000000101 X3)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X1) (bvmul #b000000001000 X3)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X0) (bvmul #b111111111110 X3)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000110 X1) (bvmul #b111111111001 X3)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X1) (bvmul #b111111111100 X3)  #b111111110110) #b000000000000))
