...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b000000001001 X1) (bvmul #b111111111111 X2) (bvmul #b000000000101 X3) (bvmul #b000000000001 X4) (bvmul #b111111111111 X5) (bvmul #b000000000011 X6) (bvmul #b000000000001 X7) (bvmul #b000000000111 X9) (bvmul #b111111111100 X10) (bvmul #b000000001000 X11)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000010 X3) (bvmul #b111111111110 X6) (bvmul #b000000001010 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000001000 X4) (bvmul #b000000000110 X9)  #b111111110111) #b000000000000))
