...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000001000 X1) (bvmul #b000000000001 X2) (bvmul #b000000000011 X3) (bvmul #b000000001001 X4) (bvmul #b111111111101 X5) (bvmul #b111111111001 X6) (bvmul #b111111111001 X7) (bvmul #b000000001001 X8)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111111 X2)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X2) (bvmul #b000000000001 X4) (bvmul #b111111111011 X8)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X3) (bvmul #b111111111100 X4) (bvmul #b111111111011 X5) (bvmul #b000000000001 X6)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b111111111010 X3) (bvmul #b111111111010 X6) (bvmul #b000000000101 X8)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000101 X2) (bvmul #b111111111101 X5) (bvmul #b111111111000 X6) (bvmul #b000000000011 X8)  #b111111111011) #b000000000000))
