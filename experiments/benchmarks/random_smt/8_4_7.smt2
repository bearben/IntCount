...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b111111111000 X1) (bvmul #b111111110111 X2) (bvmul #b111111110110 X3) (bvmul #b000000001000 X5) (bvmul #b111111111000 X6) (bvmul #b000000000100 X7)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b111111110111 X3) (bvmul #b000000001010 X4) (bvmul #b111111111001 X5) (bvmul #b000000000011 X6)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X2) (bvmul #b111111111101 X5) (bvmul #b111111110111 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X2) (bvmul #b000000001010 X3) (bvmul #b000000000110 X6)  #b000000000100) #b000000000000))
