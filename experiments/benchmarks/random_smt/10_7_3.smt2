...
(assert (bvsge (bvadd (bvmul #b000000001001 X2) (bvmul #b111111111011 X3) (bvmul #b111111110110 X8)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X2) (bvmul #b000000000011 X7)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X4)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b000000000010 X3) (bvmul #b000000000100 X6)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X3) (bvmul #b000000001001 X4) (bvmul #b000000000111 X7)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X1)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111110111 X3) (bvmul #b000000000010 X5)  #b111111111010) #b000000000000))
