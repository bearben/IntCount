...
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b111111111011 X2) (bvmul #b000000001010 X6) (bvmul #b111111111110 X7)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X2) (bvmul #b111111111100 X5) (bvmul #b111111111110 X7)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000101 X2) (bvmul #b000000001000 X4) (bvmul #b000000000101 X6)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111101 X2) (bvmul #b111111111100 X3)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b111111111001 X4) (bvmul #b000000000010 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X3)  #b000000000101) #b000000000000))
