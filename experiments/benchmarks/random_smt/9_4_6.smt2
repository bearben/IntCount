...
(assert (bvsge (bvadd (bvmul #b111111111011 X2) (bvmul #b000000000101 X4) (bvmul #b000000000100 X5) (bvmul #b111111110110 X6) (bvmul #b000000000101 X7) (bvmul #b111111111111 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000001 X4) (bvmul #b111111111110 X6)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X5)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X4) (bvmul #b111111110111 X5) (bvmul #b000000001001 X7)  #b000000000111) #b000000000000))
