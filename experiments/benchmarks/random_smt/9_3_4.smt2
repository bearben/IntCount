...
(assert (bvsge (bvadd (bvmul #b111111111100 X1) (bvmul #b000000000111 X3) (bvmul #b000000000110 X6) (bvmul #b000000001000 X8)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000001001 X5)  #b000000001001) #b000000000000))
