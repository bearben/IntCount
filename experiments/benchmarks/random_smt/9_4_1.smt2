...
(assert (bvsge (bvadd (bvmul #b000000000111 X1)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X3)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X7)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X7)  #b111111111001) #b000000000000))
