...
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b000000000011 X3) (bvmul #b000000000111 X4) (bvmul #b111111111111 X5) (bvmul #b000000000100 X6)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X0) (bvmul #b111111111101 X2) (bvmul #b000000000010 X4) (bvmul #b000000000110 X5) (bvmul #b111111111101 X6)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X4)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X5) (bvmul #b000000000110 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b000000001001 X2) (bvmul #b000000000101 X4) (bvmul #b111111111011 X5) (bvmul #b111111111001 X6)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X4) (bvmul #b000000000100 X6)  #b111111111111) #b000000000000))
