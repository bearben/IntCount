...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111000 X7) (bvmul #b000000000001 X9)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X7)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X2) (bvmul #b111111110111 X5) (bvmul #b111111110110 X8)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111011 X4) (bvmul #b111111111111 X5)  #b000000000110) #b000000000000))
