...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111001 X3) (bvmul #b111111111010 X6)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X4) (bvmul #b000000000011 X7) (bvmul #b111111111101 X8)  #b000000001001) #b000000000000))
