...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111010 X2) (bvmul #b000000000001 X3) (bvmul #b000000000100 X4) (bvmul #b000000000101 X5) (bvmul #b000000001010 X6)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b000000001001 X3)  #b000000000011) #b000000000000))
