...
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111001 X1) (bvmul #b000000000101 X2) (bvmul #b111111111000 X3) (bvmul #b111111111000 X4) (bvmul #b000000001000 X5) (bvmul #b111111111000 X6) (bvmul #b000000001000 X7) (bvmul #b000000000011 X8)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b111111110110 X1) (bvmul #b000000001010 X2) (bvmul #b000000000001 X3) (bvmul #b000000001010 X4) (bvmul #b111111111100 X5) (bvmul #b000000000010 X6) (bvmul #b000000000010 X7) (bvmul #b111111111100 X8)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000010 X1) (bvmul #b000000001010 X2) (bvmul #b111111111011 X4) (bvmul #b111111111111 X5) (bvmul #b111111111010 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1) (bvmul #b111111111000 X2) (bvmul #b000000000110 X4) (bvmul #b000000001001 X5)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b000000000101 X1) (bvmul #b111111111100 X2) (bvmul #b000000000011 X3) (bvmul #b000000000001 X4) (bvmul #b000000000011 X5) (bvmul #b111111111100 X6) (bvmul #b111111111011 X8)  #b111111111000) #b000000000000))
