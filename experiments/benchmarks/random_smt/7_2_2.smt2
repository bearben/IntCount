...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b111111111100 X1)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X0)  #b111111111100) #b000000000000))
