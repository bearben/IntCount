...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111101 X1) (bvmul #b111111111011 X2) (bvmul #b000000001000 X3) (bvmul #b111111111011 X4) (bvmul #b111111111101 X5) (bvmul #b000000001010 X6) (bvmul #b111111111000 X7) (bvmul #b111111111111 X8) (bvmul #b111111111011 X9) (bvmul #b000000000100 X10)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b000000000101 X1) (bvmul #b111111110111 X2) (bvmul #b111111111001 X3) (bvmul #b111111110110 X5) (bvmul #b111111110110 X7) (bvmul #b111111111001 X8) (bvmul #b000000000101 X9) (bvmul #b111111110111 X10)  #b111111111101) #b000000000000))
