...
(assert (bvsge (bvadd (bvmul #b111111111011 X4) (bvmul #b111111111011 X5) (bvmul #b111111111100 X6)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b000000001010 X2)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X6)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X4)  #b000000000110) #b000000000000))
