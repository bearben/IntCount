...
(assert (bvsge (bvadd (bvmul #b000000001000 X11)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X0)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X11)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X4)  #b111111111100) #b000000000000))
