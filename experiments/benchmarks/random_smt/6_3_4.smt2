...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111110111 X3) (bvmul #b111111110110 X4) (bvmul #b000000000101 X5)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X1) (bvmul #b111111111111 X3) (bvmul #b000000001000 X4)  #b000000000100) #b000000000000))
