...
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000000101 X1) (bvmul #b111111110110 X2) (bvmul #b111111111101 X5) (bvmul #b000000000010 X7) (bvmul #b111111111111 X9)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b000000000101 X4) (bvmul #b111111111101 X8)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X4)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X5) (bvmul #b111111110110 X8)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X5)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X4) (bvmul #b111111111000 X5) (bvmul #b000000000001 X9)  #b000000000101) #b000000000000))
