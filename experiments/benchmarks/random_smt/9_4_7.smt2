...
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b000000000011 X1) (bvmul #b111111111100 X2) (bvmul #b111111111101 X3) (bvmul #b000000000101 X4) (bvmul #b000000000101 X5) (bvmul #b111111110110 X6)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X3) (bvmul #b111111111000 X5) (bvmul #b111111111100 X6) (bvmul #b000000000101 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X3) (bvmul #b111111110111 X4) (bvmul #b000000000100 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b000000000111 X2) (bvmul #b111111111110 X3) (bvmul #b111111111001 X5) (bvmul #b000000000001 X6) (bvmul #b000000000110 X7) (bvmul #b111111111111 X8)  #b111111111001) #b000000000000))
