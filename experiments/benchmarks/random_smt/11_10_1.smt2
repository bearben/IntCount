...
(assert (bvsge (bvadd (bvmul #b111111111111 X10)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X9)  #b000000000100) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b000000001000 X7)  #b000000000101) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b111111110110 X0)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X2)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X9)  #b000000000011) #b000000000000))
