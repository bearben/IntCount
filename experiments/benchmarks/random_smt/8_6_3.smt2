...
(assert (bvsge (bvadd (bvmul #b000000000100 X2) (bvmul #b111111111000 X3) (bvmul #b000000001000 X7)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X3) (bvmul #b111111111110 X4) (bvmul #b000000001010 X6)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111110 X5)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X2) (bvmul #b000000000010 X4) (bvmul #b000000001000 X5)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000000101 X1) (bvmul #b000000000101 X4)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X6)  #b111111110111) #b000000000000))
