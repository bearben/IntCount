...
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b000000001010 X1) (bvmul #b111111111000 X9)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000000100 X6)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X9)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X10)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0)  #b111111111100) #b000000000000))
