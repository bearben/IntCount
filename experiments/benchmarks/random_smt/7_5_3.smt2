...
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b111111111010 X2) (bvmul #b000000001010 X3)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X1) (bvmul #b111111111000 X5)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1) (bvmul #b111111111111 X4)  #b000000000110) #b000000000000))
