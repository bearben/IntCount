...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b000000000100 X1) (bvmul #b111111111100 X2) (bvmul #b000000000110 X3) (bvmul #b000000000100 X4) (bvmul #b111111111000 X5) (bvmul #b000000000100 X6) (bvmul #b111111110111 X7) (bvmul #b000000001000 X8) (bvmul #b000000001000 X9)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000001010 X2) (bvmul #b000000000010 X3) (bvmul #b000000000101 X5) (bvmul #b111111111000 X6) (bvmul #b000000000101 X7)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b000000001000 X3)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X2)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000001 X2) (bvmul #b111111111010 X3) (bvmul #b000000001010 X6) (bvmul #b000000001000 X8) (bvmul #b111111111100 X9)  #b111111111101) #b000000000000))
