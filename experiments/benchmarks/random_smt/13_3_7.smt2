...
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b000000000100 X4) (bvmul #b000000000011 X5) (bvmul #b000000000111 X6) (bvmul #b000000000100 X7) (bvmul #b111111111000 X9) (bvmul #b000000001000 X10)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X2) (bvmul #b111111111000 X4) (bvmul #b000000000110 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111111 X6) (bvmul #b111111111001 X9) (bvmul #b000000000111 X10)  #b111111111110) #b000000000000))
