...
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111111010 X4) (bvmul #b000000000010 X9) (bvmul #b000000000001 X11)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111111 X2) (bvmul #b000000000011 X8) (bvmul #b000000000110 X9)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X6)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X4) (bvmul #b111111111110 X5) (bvmul #b000000001010 X6) (bvmul #b000000000110 X7)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X4)  #b000000000010) #b000000000000))
