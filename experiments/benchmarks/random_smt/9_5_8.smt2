...
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b000000000110 X1) (bvmul #b000000000111 X2) (bvmul #b111111111100 X3) (bvmul #b000000000101 X4) (bvmul #b111111111001 X6) (bvmul #b111111111001 X7) (bvmul #b000000000001 X8)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X2) (bvmul #b111111111000 X4) (bvmul #b000000000011 X5) (bvmul #b000000000010 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b111111111000 X1) (bvmul #b000000000011 X5)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111101 X1) (bvmul #b111111111001 X2) (bvmul #b111111111001 X3) (bvmul #b000000000001 X5) (bvmul #b111111111101 X7) (bvmul #b000000000101 X8)  #b111111111111) #b000000000000))
