...
(assert (bvsge (bvadd (bvmul #b000000001000 X7)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X4)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X8)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X9)  #b111111111110) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b000000000101 X2)  #b111111111101) #b000000000000))
