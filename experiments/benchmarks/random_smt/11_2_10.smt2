...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111110110 X2) (bvmul #b111111111001 X3) (bvmul #b000000000001 X4) (bvmul #b111111110110 X5) (bvmul #b111111111001 X6) (bvmul #b111111111100 X7) (bvmul #b000000000100 X8) (bvmul #b000000000011 X9) (bvmul #b111111111001 X10)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111010 X1) (bvmul #b111111111110 X3) (bvmul #b111111111100 X4) (bvmul #b111111111111 X5) (bvmul #b000000000001 X6) (bvmul #b000000001000 X7) (bvmul #b111111111000 X8) (bvmul #b000000000101 X10)  #b000000000110) #b000000000000))
