...
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b000000001010 X1) (bvmul #b111111111000 X2) (bvmul #b000000000110 X3) (bvmul #b111111111100 X4) (bvmul #b111111110111 X5) (bvmul #b000000000101 X6) (bvmul #b000000000110 X7) (bvmul #b111111110110 X8)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000001010 X1) (bvmul #b111111111100 X2) (bvmul #b000000000100 X3) (bvmul #b111111110111 X4) (bvmul #b111111111001 X5) (bvmul #b000000000010 X7) (bvmul #b000000000100 X8)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111110111 X1) (bvmul #b000000001010 X2) (bvmul #b111111111100 X3) (bvmul #b000000000001 X4) (bvmul #b111111111010 X6) (bvmul #b000000000010 X8)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X4)  #b111111111001) #b000000000000))
