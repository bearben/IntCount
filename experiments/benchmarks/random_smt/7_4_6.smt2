...
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111000 X2) (bvmul #b000000000101 X3) (bvmul #b000000000110 X4) (bvmul #b111111111100 X5) (bvmul #b000000001000 X6)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111111101 X2) (bvmul #b111111111110 X4)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b000000000001 X1) (bvmul #b000000000110 X2) (bvmul #b000000001010 X3) (bvmul #b000000000101 X4) (bvmul #b000000001001 X5)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X1) (bvmul #b000000001010 X2)  #b111111111011) #b000000000000))
