...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000001000 X1) (bvmul #b111111111100 X4) (bvmul #b000000000111 X5) (bvmul #b111111111011 X7) (bvmul #b111111111000 X8) (bvmul #b111111111011 X9)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X3) (bvmul #b111111111000 X8)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111110110 X2) (bvmul #b000000000101 X5) (bvmul #b111111111101 X6)  #b000000000010) #b000000000000))
