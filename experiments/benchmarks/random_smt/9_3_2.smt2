...
(assert (bvsge (bvadd (bvmul #b000000001000 X6) (bvmul #b111111111011 X7)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X3)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1)  #b000000000000) #b000000000000))
