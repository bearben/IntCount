...
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b000000000010 X2) (bvmul #b000000000110 X3) (bvmul #b000000000001 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X4)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X5) (bvmul #b000000000001 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b111111111000 X2) (bvmul #b000000000101 X3) (bvmul #b000000001000 X6)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b000000000011 X2) (bvmul #b111111111100 X5)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b000000000001 X3) (bvmul #b111111111001 X5)  #b111111111010) #b000000000000))
