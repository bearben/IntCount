...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000001010 X1) (bvmul #b111111111111 X2) (bvmul #b000000000001 X3) (bvmul #b111111111110 X4) (bvmul #b111111111011 X5) (bvmul #b111111110110 X6) (bvmul #b000000001010 X7)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000011 X1) (bvmul #b111111111010 X2) (bvmul #b111111111001 X3) (bvmul #b000000001000 X4) (bvmul #b111111111110 X5)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b111111111100 X1) (bvmul #b111111111110 X2) (bvmul #b000000001010 X3) (bvmul #b000000000011 X4) (bvmul #b111111111011 X5) (bvmul #b111111111111 X6) (bvmul #b000000000111 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b111111111000 X6)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111100 X4) (bvmul #b000000000101 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000001001 X3) (bvmul #b111111110110 X5) (bvmul #b000000000011 X6)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b111111111111 X1) (bvmul #b000000000101 X2) (bvmul #b000000000010 X3) (bvmul #b000000000110 X4) (bvmul #b111111111110 X6) (bvmul #b111111111010 X7)  #b000000000100) #b000000000000))
