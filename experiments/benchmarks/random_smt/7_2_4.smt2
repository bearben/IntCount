...
(assert (bvsge (bvadd (bvmul #b111111111001 X2) (bvmul #b111111111011 X3) (bvmul #b111111111110 X5) (bvmul #b111111110111 X6)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X0) (bvmul #b111111111011 X2) (bvmul #b000000000111 X3)  #b000000000000) #b000000000000))
