...
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b111111111101 X2) (bvmul #b000000000100 X3) (bvmul #b111111111110 X4) (bvmul #b000000000001 X5) (bvmul #b111111111011 X6) (bvmul #b000000001001 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X3)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111011 X2) (bvmul #b000000000001 X4) (bvmul #b111111111011 X5) (bvmul #b000000000110 X6)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b111111111001 X1) (bvmul #b000000001001 X2) (bvmul #b000000000011 X3) (bvmul #b000000000110 X4) (bvmul #b111111111010 X6) (bvmul #b000000001010 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X3)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111110 X1) (bvmul #b000000000111 X3) (bvmul #b000000001000 X4) (bvmul #b000000001010 X5) (bvmul #b111111111110 X6) (bvmul #b111111111011 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111111101 X7)  #b000000000010) #b000000000000))
