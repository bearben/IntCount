...
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b000000001010 X2) (bvmul #b111111110111 X3) (bvmul #b000000000100 X4) (bvmul #b111111110110 X5) (bvmul #b111111111111 X6) (bvmul #b000000000110 X7) (bvmul #b111111110110 X8) (bvmul #b000000000010 X9)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b000000001010 X3) (bvmul #b000000000111 X4) (bvmul #b000000000011 X6) (bvmul #b111111111001 X8) (bvmul #b111111111001 X9)  #b111111111001) #b000000000000))
