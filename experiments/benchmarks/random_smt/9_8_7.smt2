...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b000000000111 X2) (bvmul #b000000000111 X3) (bvmul #b000000000010 X4) (bvmul #b000000000010 X5) (bvmul #b000000001001 X6) (bvmul #b000000001000 X8)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X2) (bvmul #b000000001001 X3) (bvmul #b000000000101 X7) (bvmul #b000000000101 X8)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000111 X4)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b111111111011 X4) (bvmul #b111111111100 X6)  #b111111111011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000000111 X1) (bvmul #b000000000010 X3) (bvmul #b000000000110 X4)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1) (bvmul #b000000000100 X3) (bvmul #b000000000001 X4) (bvmul #b111111111100 X5)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b111111111010 X2) (bvmul #b000000000111 X5) (bvmul #b111111111110 X6) (bvmul #b000000000101 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000000101 X7) (bvmul #b111111111100 X8)  #b000000001000) #b000000000000))
