...
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111110111 X1) (bvmul #b111111111100 X2) (bvmul #b000000001001 X3) (bvmul #b111111111101 X4) (bvmul #b000000001000 X5)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111110111 X1) (bvmul #b111111110111 X2) (bvmul #b000000000011 X3) (bvmul #b000000000001 X4) (bvmul #b000000001000 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1) (bvmul #b111111110111 X2) (bvmul #b000000001001 X6)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111110111 X1) (bvmul #b000000000111 X2) (bvmul #b000000000010 X4) (bvmul #b000000001001 X5)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b111111111100 X2)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X2) (bvmul #b000000000110 X3) (bvmul #b000000000010 X4) (bvmul #b000000001010 X5) (bvmul #b111111111000 X6)  #b111111111101) #b000000000000))
