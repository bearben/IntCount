...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000001010 X3)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X7) (bvmul #b111111111111 X10)  #b000000001001) #b000000000000))
