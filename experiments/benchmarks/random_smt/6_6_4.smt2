...
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b000000001001 X1) (bvmul #b111111111111 X3) (bvmul #b000000000100 X4)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1) (bvmul #b000000000011 X2) (bvmul #b000000000010 X3) (bvmul #b111111110110 X4)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X3) (bvmul #b111111111011 X5)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111110 X2)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b000000001010 X2)  #b000000000000) #b000000000000))
