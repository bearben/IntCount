...
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b111111110110 X2) (bvmul #b000000000011 X4) (bvmul #b000000000101 X5) (bvmul #b000000000101 X6) (bvmul #b111111111001 X9) (bvmul #b111111111110 X10) (bvmul #b111111111111 X11)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X5) (bvmul #b000000000111 X8)  #b000000001010) #b000000000000))
