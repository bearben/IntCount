...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111110 X2) (bvmul #b000000000101 X4) (bvmul #b000000000111 X5) (bvmul #b111111110111 X6) (bvmul #b000000000110 X8)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X0) (bvmul #b000000000111 X1) (bvmul #b111111111111 X2) (bvmul #b111111111011 X4) (bvmul #b111111110110 X8)  #b111111111011) #b000000000000))
