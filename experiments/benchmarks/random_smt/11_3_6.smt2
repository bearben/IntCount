...
(assert (bvsge (bvadd (bvmul #b111111111110 X3) (bvmul #b111111111111 X4) (bvmul #b000000000101 X6) (bvmul #b111111110110 X7) (bvmul #b000000001010 X9) (bvmul #b111111111000 X10)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X2) (bvmul #b000000001001 X3) (bvmul #b111111111101 X9)  #b111111111110) #b000000000000))
