...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111001 X1) (bvmul #b000000000010 X2) (bvmul #b000000000100 X3) (bvmul #b000000000110 X5) (bvmul #b111111111111 X6) (bvmul #b000000000001 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X1) (bvmul #b111111111001 X4) (bvmul #b000000001010 X9)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X6)  #b000000000110) #b000000000000))
