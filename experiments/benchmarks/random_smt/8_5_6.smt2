...
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b000000000111 X2) (bvmul #b111111111011 X3) (bvmul #b000000000111 X4) (bvmul #b000000001001 X5) (bvmul #b111111111110 X6)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b000000000011 X5) (bvmul #b000000000100 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b111111111000 X4) (bvmul #b111111111101 X5) (bvmul #b000000000100 X6) (bvmul #b111111111110 X7)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X2) (bvmul #b000000000100 X3) (bvmul #b000000000111 X6)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X5) (bvmul #b000000000111 X6)  #b111111110110) #b000000000000))
