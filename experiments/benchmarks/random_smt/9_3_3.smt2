...
(assert (bvsge (bvadd (bvmul #b111111111010 X3) (bvmul #b111111111000 X4) (bvmul #b000000000101 X6)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X0) (bvmul #b000000000101 X4) (bvmul #b111111110110 X5)  #b000000001000) #b000000000000))
