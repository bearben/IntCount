...
(assert (bvsge (bvadd (bvmul #b111111111010 X2) (bvmul #b111111111111 X4) (bvmul #b111111111000 X5) (bvmul #b000000001000 X7)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X1) (bvmul #b000000001001 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b111111111101 X7) (bvmul #b111111111100 X8)  #b111111111100) #b000000000000))
