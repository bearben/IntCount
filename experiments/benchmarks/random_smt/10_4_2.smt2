...
(assert (bvsge (bvadd (bvmul #b111111111111 X3) (bvmul #b111111111100 X8)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X2) (bvmul #b000000000111 X4)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X4) (bvmul #b111111111011 X8)  #b111111111111) #b000000000000))
