...
(assert (bvsge (bvadd (bvmul #b111111111101 X4) (bvmul #b111111111100 X10)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X2) (bvmul #b111111111100 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X3) (bvmul #b000000001000 X9)  #b111111111100) #b000000000000))
