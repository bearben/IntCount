...
(assert (bvsge (bvadd (bvmul #b000000000001 X0) (bvmul #b000000000001 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b000000000100 X5)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X2) (bvmul #b000000000001 X7)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X4)  #b000000000011) #b000000000000))
