...
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b000000000010 X1) (bvmul #b111111111110 X2) (bvmul #b000000000111 X4) (bvmul #b111111110111 X6) (bvmul #b000000000011 X7) (bvmul #b111111110110 X8) (bvmul #b000000000101 X9)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X2) (bvmul #b000000001000 X3) (bvmul #b111111110111 X4) (bvmul #b111111111100 X7)  #b111111111010) #b000000000000))
