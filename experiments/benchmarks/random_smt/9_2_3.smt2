...
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b000000000001 X5) (bvmul #b000000001001 X7)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X6) (bvmul #b111111111001 X7)  #b000000001001) #b000000000000))
