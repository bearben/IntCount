...
(assert (bvsge (bvadd (bvmul #b000000000111 X0) (bvmul #b111111110111 X1) (bvmul #b000000000010 X2) (bvmul #b000000000011 X3) (bvmul #b000000000110 X4) (bvmul #b000000001010 X5)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000000101 X2) (bvmul #b000000000111 X3) (bvmul #b111111111100 X4) (bvmul #b111111110111 X5)  #b000000000011) #b000000000000))
