...
(assert (bvsge (bvadd (bvmul #b111111110111 X2) (bvmul #b000000000111 X3)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b111111110111 X5)  #b000000000111) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b111111111101 X2)  #b111111111101) #b000000000000))
