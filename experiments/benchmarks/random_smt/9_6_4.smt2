...
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b000000001001 X5) (bvmul #b111111111110 X6) (bvmul #b111111111001 X8)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X6)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X0) (bvmul #b000000001010 X1) (bvmul #b111111111010 X2)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111111 X5)  #b111111110110) #b000000000000))
