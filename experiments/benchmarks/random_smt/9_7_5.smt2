...
(assert (bvsge (bvadd (bvmul #b000000000110 X0) (bvmul #b000000000010 X1) (bvmul #b111111111010 X4) (bvmul #b111111111010 X7) (bvmul #b111111111110 X8)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b111111111001 X2) (bvmul #b000000000101 X4) (bvmul #b000000001000 X6)  #b000000000110) #b000000000000))
...
(assert (bvsge (bvadd (bvmul #b000000000010 X0) (bvmul #b000000000010 X1) (bvmul #b111111111001 X3)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X3) (bvmul #b111111111000 X4) (bvmul #b000000001001 X5) (bvmul #b111111111010 X7) (bvmul #b111111111011 X8)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b000000000100 X3) (bvmul #b111111111111 X5) (bvmul #b111111111001 X7)  #b000000000001) #b000000000000))
