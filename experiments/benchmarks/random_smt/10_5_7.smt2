...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000111 X1) (bvmul #b111111111000 X3) (bvmul #b000000000001 X4) (bvmul #b000000000111 X5) (bvmul #b111111110110 X7) (bvmul #b000000000010 X9)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111001 X1) (bvmul #b111111111010 X2) (bvmul #b111111111000 X3) (bvmul #b000000000100 X4) (bvmul #b000000000010 X6)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X7) (bvmul #b000000000100 X9)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X3) (bvmul #b111111110110 X4) (bvmul #b000000001000 X6) (bvmul #b111111111001 X7) (bvmul #b111111111100 X9)  #b111111111100) #b000000000000))
