...
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b111111111000 X1) (bvmul #b111111111010 X3) (bvmul #b000000000011 X4) (bvmul #b000000000010 X8)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X2) (bvmul #b000000000011 X8) (bvmul #b000000001010 X9)  #b000000000000) #b000000000000))
