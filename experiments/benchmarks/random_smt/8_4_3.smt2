...
(assert (bvsge (bvadd (bvmul #b000000001001 X5) (bvmul #b111111110111 X6) (bvmul #b000000000100 X7)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X1) (bvmul #b000000000111 X3) (bvmul #b111111110110 X5)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X6)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X1)  #b000000000100) #b000000000000))
