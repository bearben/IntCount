...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000000111 X1) (bvmul #b000000000101 X3) (bvmul #b000000001001 X5) (bvmul #b111111111110 X6) (bvmul #b111111111101 X7) (bvmul #b111111111001 X8)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b000000001001 X1) (bvmul #b111111110111 X3) (bvmul #b000000000101 X5) (bvmul #b111111110111 X8) (bvmul #b111111111001 X9)  #b000000000001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X1) (bvmul #b000000000010 X3) (bvmul #b000000000101 X4) (bvmul #b000000000001 X5) (bvmul #b000000000011 X7) (bvmul #b111111110111 X8) (bvmul #b111111111011 X9)  #b111111111110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b111111110111 X5) (bvmul #b111111110110 X9)  #b111111111111) #b000000000000))
