...
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b111111110111 X3) (bvmul #b111111111101 X8)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111111100 X2) (bvmul #b000000000011 X3)  #b111111111001) #b000000000000))
