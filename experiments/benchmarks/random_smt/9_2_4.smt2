...
(assert (bvsge (bvadd (bvmul #b000000000001 X5) (bvmul #b000000000011 X6) (bvmul #b111111110111 X7) (bvmul #b000000000001 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X2) (bvmul #b111111111000 X3) (bvmul #b111111110110 X4) (bvmul #b111111111111 X6)  #b111111110111) #b000000000000))
