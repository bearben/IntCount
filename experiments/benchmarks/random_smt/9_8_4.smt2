...
(assert (bvsge (bvadd (bvmul #b111111111010 X3) (bvmul #b111111110110 X4) (bvmul #b111111111000 X6) (bvmul #b000000001000 X8)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X3)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111100 X6)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X5) (bvmul #b111111111100 X7)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X1) (bvmul #b111111111000 X2) (bvmul #b000000000011 X6) (bvmul #b111111111000 X8)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2) (bvmul #b111111111000 X6)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b111111110110 X7)  #b111111110111) #b000000000000))
