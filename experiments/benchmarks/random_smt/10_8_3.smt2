...
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b000000000001 X2) (bvmul #b000000000001 X4)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X3) (bvmul #b000000000010 X4) (bvmul #b000000000001 X6)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X4) (bvmul #b000000000011 X6)  #b000000000011) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1) (bvmul #b000000000101 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2) (bvmul #b111111111101 X5) (bvmul #b111111111011 X9)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X5)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X1) (bvmul #b000000000101 X2)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X4)  #b000000001001) #b000000000000))
