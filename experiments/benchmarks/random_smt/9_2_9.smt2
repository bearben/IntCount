...
(assert (bvsge (bvadd (bvmul #b111111111100 X0) (bvmul #b111111111011 X1) (bvmul #b000000000100 X2) (bvmul #b111111111101 X3) (bvmul #b000000000101 X4) (bvmul #b111111111100 X5) (bvmul #b111111110111 X6) (bvmul #b000000000010 X7) (bvmul #b000000000100 X8)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b111111111110 X1) (bvmul #b111111111010 X2) (bvmul #b111111110111 X3) (bvmul #b000000000001 X4) (bvmul #b000000001000 X5) (bvmul #b111111111101 X6) (bvmul #b111111111110 X7) (bvmul #b000000000101 X8)  #b111111111001) #b000000000000))
