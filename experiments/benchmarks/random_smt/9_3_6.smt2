...
(assert (bvsge (bvadd (bvmul #b111111111101 X1) (bvmul #b111111111111 X2) (bvmul #b000000000001 X4) (bvmul #b000000000110 X5) (bvmul #b000000000101 X6) (bvmul #b111111110110 X7)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X0) (bvmul #b000000000100 X3) (bvmul #b111111111011 X7) (bvmul #b111111111110 X8)  #b111111111010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111111110 X1) (bvmul #b000000000100 X3) (bvmul #b000000000110 X4) (bvmul #b000000001000 X6) (bvmul #b111111111001 X7)  #b111111110110) #b000000000000))
