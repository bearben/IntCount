...
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b111111110110 X1) (bvmul #b111111110111 X2) (bvmul #b000000000010 X3) (bvmul #b111111111111 X7) (bvmul #b111111111011 X8) (bvmul #b000000000010 X10) (bvmul #b111111111001 X11) (bvmul #b000000000111 X12)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X4) (bvmul #b111111111000 X7) (bvmul #b111111110111 X8) (bvmul #b111111111110 X9) (bvmul #b111111111101 X11) (bvmul #b111111110111 X12)  #b000000000101) #b000000000000))
