...
(assert (bvsge (bvadd (bvmul #b111111111011 X1) (bvmul #b111111111000 X2) (bvmul #b111111111111 X6) (bvmul #b111111111011 X9)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0) (bvmul #b111111111001 X2) (bvmul #b000000000011 X7) (bvmul #b111111110111 X9)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X4) (bvmul #b000000000001 X11)  #b000000000000) #b000000000000))
