...
(assert (bvsge (bvadd (bvmul #b000000000100 X0) (bvmul #b111111111101 X1) (bvmul #b111111111100 X4) (bvmul #b000000001001 X5) (bvmul #b111111111100 X7) (bvmul #b111111111101 X8)  #b000000001010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X3)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X2) (bvmul #b000000000100 X5)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000001 X1) (bvmul #b111111111011 X3) (bvmul #b000000000110 X7) (bvmul #b111111111001 X8) (bvmul #b111111110110 X9)  #b111111111011) #b000000000000))
