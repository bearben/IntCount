...
(assert (bvsge (bvadd (bvmul #b111111111101 X2) (bvmul #b000000000100 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X2) (bvmul #b111111110111 X7)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X5)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X9)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001001 X2) (bvmul #b000000001000 X9)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X2)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X2) (bvmul #b000000000101 X5)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X2) (bvmul #b111111110110 X9)  #b111111111101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X1)  #b000000000011) #b000000000000))
