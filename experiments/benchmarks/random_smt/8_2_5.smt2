...
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b000000000100 X2) (bvmul #b000000000101 X4) (bvmul #b000000000010 X5) (bvmul #b111111111001 X7)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000000010 X2) (bvmul #b000000000001 X4) (bvmul #b000000000111 X6) (bvmul #b000000000110 X7)  #b000000001000) #b000000000000))
