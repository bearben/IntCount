...
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b111111111010 X1) (bvmul #b111111111111 X2) (bvmul #b111111111111 X4) (bvmul #b111111111001 X5) (bvmul #b000000000111 X6)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X6)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X1) (bvmul #b000000000100 X4) (bvmul #b000000001000 X5)  #b111111111111) #b000000000000))
