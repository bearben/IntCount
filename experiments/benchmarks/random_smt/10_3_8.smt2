...
(assert (bvsge (bvadd (bvmul #b000000001001 X0) (bvmul #b000000000011 X1) (bvmul #b111111111010 X2) (bvmul #b111111111001 X3) (bvmul #b000000000010 X5) (bvmul #b111111111010 X6) (bvmul #b000000001001 X7) (bvmul #b111111110111 X8)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000111 X1) (bvmul #b000000000100 X6) (bvmul #b111111111110 X7) (bvmul #b000000001000 X8) (bvmul #b000000000100 X9)  #b000000000011) #b000000000000))
