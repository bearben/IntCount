...
(assert (bvsge (bvadd (bvmul #b000000001010 X0) (bvmul #b111111111101 X1) (bvmul #b000000000100 X2) (bvmul #b111111111000 X3) (bvmul #b000000000011 X4) (bvmul #b000000000011 X5) (bvmul #b111111111101 X7) (bvmul #b111111111001 X8)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b000000000001 X1) (bvmul #b000000000011 X2) (bvmul #b111111111111 X3) (bvmul #b111111111010 X4) (bvmul #b111111111001 X5) (bvmul #b111111111110 X6) (bvmul #b111111111111 X8)  #b111111111100) #b000000000000))
