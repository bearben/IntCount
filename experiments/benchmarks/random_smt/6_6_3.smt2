...
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111010 X2) (bvmul #b111111111100 X3)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X0)  #b111111111111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000100 X1) (bvmul #b111111110110 X4) (bvmul #b111111110110 X5)  #b000000000100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X1) (bvmul #b000000000110 X3) (bvmul #b111111110111 X5)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000110 X2)  #b000000000111) #b000000000000))
