...
(assert (bvsge (bvadd (bvmul #b111111111101 X0) (bvmul #b000000001001 X1) (bvmul #b000000000011 X2) (bvmul #b111111110110 X3) (bvmul #b111111111110 X7)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000010 X3) (bvmul #b000000000001 X7)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111101 X5)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110110 X0) (bvmul #b000000001000 X2) (bvmul #b111111111100 X7)  #b111111111000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111100 X1) (bvmul #b111111111110 X2) (bvmul #b000000001001 X3) (bvmul #b111111111100 X4) (bvmul #b000000001010 X7)  #b000000000111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X0)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X1) (bvmul #b111111111101 X4) (bvmul #b000000000011 X6) (bvmul #b000000000001 X7)  #b000000001000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000011 X7)  #b111111111100) #b000000000000))
