...
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111011 X1)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b000000000001 X2)  #b000000000010) #b000000000000))
