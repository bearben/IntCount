...
(assert (bvsge (bvadd (bvmul #b000000001000 X0) (bvmul #b000000001010 X2) (bvmul #b000000000111 X4) (bvmul #b111111111100 X6) (bvmul #b000000000110 X7)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X6)  #b111111111001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X1) (bvmul #b111111111101 X2) (bvmul #b000000000110 X7)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000001010 X7)  #b111111111100) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111010 X0) (bvmul #b000000001010 X4) (bvmul #b000000000101 X8)  #b000000000010) #b000000000000))
(assert (bvsge (bvadd (bvmul #b000000000101 X2) (bvmul #b000000000011 X5)  #b111111110110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111000 X0) (bvmul #b111111111000 X7) (bvmul #b000000000001 X8)  #b000000001001) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111110 X0) (bvmul #b111111111000 X1) (bvmul #b111111111011 X7)  #b000000000000) #b000000000000))
