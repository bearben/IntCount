...
(assert (bvsge (bvadd (bvmul #b000000001001 X1) (bvmul #b111111110111 X4) (bvmul #b000000001010 X6) (bvmul #b000000001010 X7) (bvmul #b000000000010 X9)  #b000000000000) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X0) (bvmul #b000000001001 X4) (bvmul #b000000000111 X7) (bvmul #b111111111100 X8) (bvmul #b111111111111 X9)  #b000000000101) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111001 X4) (bvmul #b111111111110 X5) (bvmul #b111111111001 X6) (bvmul #b000000000011 X7) (bvmul #b000000000101 X8)  #b000000000110) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111111111 X2) (bvmul #b000000001010 X3) (bvmul #b111111111001 X6) (bvmul #b111111111100 X7) (bvmul #b000000001010 X8)  #b111111110111) #b000000000000))
(assert (bvsge (bvadd (bvmul #b111111110111 X1) (bvmul #b111111111111 X3) (bvmul #b000000001001 X4) (bvmul #b000000001000 X5) (bvmul #b111111111010 X7)  #b000000000011) #b000000000000))
