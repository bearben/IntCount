; output/00000428.smt: generated with canalyze.
...
(assert (< 0 $5))
; ((($11 + 1(U32)) & 1(U32)) == 1(U32)) Assumption: true
; (($10 & 1(U32)) == 0(U32)) Assumption: false
; [sym$regval:7 [field: [sym$regval:0 [var: plan]$]->r2c_resolve]$] != NULL Assumption: true
(declare-const $7 Int)
