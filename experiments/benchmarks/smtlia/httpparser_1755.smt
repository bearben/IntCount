; output/00004101.smt: generated with canalyze.
; ($cast: int $16$ == 10(S32)) Assumption: true
(declare-const $16 Int)
(assert (and (< (- 128) $16) (< $16 127)))
(assert (= $16 10))
; (($cast: long $7$ - 2(S64)) >= 1(S64)) Assumption: true
(declare-const $7 Int)
(assert (and (< 0 $7) (< $7 18446744073709551615)))
(assert (>= (- $7 2) 1))
; (2(U64) == $6) Assumption: false
(declare-const $6 Int)
(assert (and (< 0 $6) (< $6 18446744073709551615)))
(assert (not (= 2 $6)))
; (2(U64) < $5) Assumption: true
(declare-const $5 Int)
...
(assert (not (= $8 10)))
; ($cast: int $8$ != 13(S32)) Assumption: true
(assert (not (= $8 13)))
