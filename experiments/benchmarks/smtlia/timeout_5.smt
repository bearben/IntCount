...
; [sym$regval:7 [field: [sym$regval:1 [field: [sym$regval:0 [var: to]$]->pending]$]->tqh_first]$] == NULL Assumption: false
(declare-const $7 Int)
...
(assert (>= (- $4 0) 8))
; [sym$regval:2 [field: [field: [sym$regval:0 [var: to]$]->tqe]->tqe_next]$] != NULL Assumption: false
(declare-const $2 Int)
