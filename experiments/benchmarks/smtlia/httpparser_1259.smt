; output/00002576.smt: generated with canalyze.
; (2(S32) < $25) Assumption: false
(declare-const $25 Int)
(assert (and (< (- 2147483648) $25) (< $25 2147483647)))
(assert (not (< 2 $25)))
; (1(S32) < $25) Assumption: true
(assert (< 1 $25))
...
(assert (not (= $14 0)))
; ($cast: unsigned int $54$ != 5(U32)) Assumption: false
(declare-const $54 Int)
(assert (and (< 0 $54) (< $54 4294967295)))
(assert (not (not (= $54 5))))
; $cast: int $21$ Assumption: true
