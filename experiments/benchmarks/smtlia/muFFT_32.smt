...
(assert (>= (- $9 8) 8))
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long (1(U32) + (3(U32) * ($5 * ($4 >> 2(S32)))))$))) >= 8(S64)) Assumption: true
(declare-const $7 Int)
(assert (and (< 0 $7) (< $7 18446744073709551615)))
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long (1(U32) + (2(U32) * ($5 * ($4 >> 2(S32)))))$))) >= 8(S64)) Assumption: true
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long (1(U32) + ($5 * ($4 >> 2(S32))))$))) >= 8(S64)) Assumption: true
