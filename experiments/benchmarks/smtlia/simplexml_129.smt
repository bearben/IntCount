; output/00000237.smt: generated with canalyze.
; ((((((($1 + 1(S32)) + 1(S32)) - 1(S32)) - 1(S32)) - 1(S32)) - 1(S32)) >= ($1 + 1(S32))) Assumption: false
(declare-const $1 Int)
(assert (and (< (- 2147483648) $1) (< $1 2147483647)))
(assert (not (>= (- (- (- (- (+ (+ $1 1) 1) 1) 1) 1) 1) (+ $1 1))))
; ($cast: int $21$ == 32(S32)) Assumption: false
...
; ($cast: int $16$ == 32(S32)) Assumption: true
