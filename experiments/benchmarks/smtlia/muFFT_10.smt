...
; (2(U32) < ($2 >> 1(S32))) Assumption: false
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long ((2(U32) - (1(U32) & ($3 - 1(U32)))) + $3)$))) >= 8(S64)) Assumption: true
(declare-const $7 Int)
(assert (and (< 0 $7) (< $7 18446744073709551615)))
(declare-const $3 Int)
(assert (and (< 0 $3) (< $3 4294967295)))
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long ((2(U32) - (1(U32) & ($3 - 1(U32)))) + 0(U32))$))) >= 8(S64)) Assumption: true
; (($cast: long $4$ - (8(S64) * (0(S64) + $cast: long (1(U32) + ($2 >> 1(S32)))$))) >= 8(S64)) Assumption: true
(declare-const $4 Int)
