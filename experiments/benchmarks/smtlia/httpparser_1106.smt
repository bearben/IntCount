; output/00002116.smt: generated with canalyze.
; ($cast: unsigned long long $23$ != 18446744073709551615(U64)) Assumption: true
(declare-const $23 Int)
(assert (and (< 0 $23) (< $23 18446744073709551615)))
(assert (not (= $23 18446744073709551615)))
; ($cast: int $21$ & 1(S32)) Assumption: false
; ($cast: int $21$ & 64(S32)) Assumption: false
