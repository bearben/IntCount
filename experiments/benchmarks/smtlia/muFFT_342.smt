; output/00000362.smt: generated with canalyze.
; (3(U32) < $11) Assumption: false
(declare-const $11 Int)
(assert (and (< 0 $11) (< $11 4294967295)))
(assert (not (< 3 $11)))
; (($cast: long $15$ - 48(S64)) >= 24(S64)) Assumption: true
...
(assert (>= (- $15 0) 24))
; [sym$regval:14 [field: [sym$regval:6 [field: [sym$regval:0 [var: plan]$]->output_plan]$]->c2r_resolve]$] != NULL Assumption: true
...
; [sym$regval:12 [field: [sym$regval:6 [field: [sym$regval:0 [var: plan]$]->output_plan]$]->r2c_resolve]$] != NULL Assumption: true
