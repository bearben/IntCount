...
(assert (>= (- $7 32) 8))
; (($cast: long $5$ - (8(S64) * (0(S64) + $cast: long (1(U32) + (3(U32) * ($4 >> 2(S32))))$))) >= 8(S64)) Assumption: true
(declare-const $5 Int)
(assert (and (< 0 $5) (< $5 18446744073709551615)))
; (($cast: long $5$ - (8(S64) * (0(S64) + $cast: long (1(U32) + (2(U32) * ($4 >> 2(S32))))$))) >= 8(S64)) Assumption: true
...
(assert (not (= $2 0)))
; (($cast: long $5$ - (8(S64) * (0(S64) + $cast: long (0(U32) + (3(U32) * ($4 >> 2(S32))))$))) >= 8(S64)) Assumption: true
; (($cast: long $5$ - (8(S64) * (0(S64) + $cast: long (0(U32) + (2(U32) * ($4 >> 2(S32))))$))) >= 8(S64)) Assumption: true
