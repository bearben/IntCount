; output/00004009.smt: generated with canalyze.
; ($10 == 0(S32)) Assumption: true
(declare-const $10 Int)
(assert (and (< (- 2147483648) $10) (< $10 2147483647)))
(assert (= $10 0))
; ($cast: int $35$ == 58(S32)) Assumption: false
(declare-const $35 Int)
(assert (and (< (- 128) $35) (< $35 127)))
(assert (not (= $35 58)))
; ($cast: int $cast: unsigned char ($cast: int $35$ | 32(S32))$$ <= 122(S32)) Assumption: false
; ($cast: int $cast: unsigned char ($cast: int $35$ | 32(S32))$$ >= 97(S32)) Assumption: true
; ($cast: int $35$ == 10(S32)) Assumption: false
(assert (not (= $35 10)))
...
(assert (< 2 (+ 0 $13)))
; ($cast: int $cast: unsigned char ($cast: int $34$ | 32(S32))$$ <= 122(S32)) Assumption: true
