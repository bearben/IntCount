; output/00000108.smt: generated with canalyze.
; (($cast: long (1(U64) * $cast: unsigned long ((($5 - (($2 + 1(S32)) + 1(S32))) + 1(S32)) + 1(S32))$)$ - (1(S64) * (0(S64) + $cast: long (($5 - (($2 + 1(S32)) + 1(S32))) + 1(S32))$))) >= 1(S64)) Assumption: true
(declare-const $5 Int)
(assert (and (< (- 2147483648) $5) (< $5 2147483647)))
(declare-const $2 Int)
(assert (and (< (- 2147483648) $2) (< $2 2147483647)))
(assert (>= (- (* 1 (+ (+ (- $5 (+ (+ $2 1) 1)) 1) 1)) (* 1 (+ 0 (+ (- $5 (+ (+ $2 1) 1)) 1)))) 1))
; ((1(U64) * $cast: unsigned long ((($5 - (($2 + 1(S32)) + 1(S32))) + 1(S32)) + 1(S32))$) > 0(U64)) Assumption: true
(assert (> (* 1 (+ (+ (- $5 (+ (+ $2 1) 1)) 1) 1)) 0))
; ($5 >= (($2 + 1(S32)) + 1(S32))) Assumption: true
(assert (>= $5 (+ (+ $2 1) 1)))
