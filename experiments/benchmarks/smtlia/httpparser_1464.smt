; output/00003388.smt: generated with canalyze.
; ((528(S64) - (16(S64) * (0(S64) + $cast: long $cast: enum http_errno $cast: enum http_errno $15$$$))) >= 16(S64)) Assumption: true
(declare-const $15 Int)
(assert (and (< 0 $15) (< $15 4294967295)))
(assert (>= (- 528 (* 16 (+ 0 $15))) 16))
; ($cast: size_t $cast: enum http_errno $cast: enum http_errno $15$$$ < 33(U64)) Assumption: true
(assert (< $15 33))
...
(assert (< $4 33))
; ($cast: unsigned int $4$ != $cast: unsigned int $cast: enum http_errno $15$$) Assumption: true
(assert (not (= $4 $15)))
; ($cast: unsigned int $cast: enum http_errno $15$$ != 0(U32)) Assumption: true
(assert (not (= $15 0)))
; (0(S32) != $13) Assumption: false
(declare-const $13 Int)
(assert (and (< (- 2147483648) $13) (< $13 2147483647)))
(assert (not (not (= 0 $13))))
; [sym$regval:12 [field: [var: settings]->on_message_begin]$] == NULL Assumption: false
