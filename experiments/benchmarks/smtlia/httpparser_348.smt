; output/00000535.smt: generated with canalyze.
; ($cast: int $1$ == 44(S32)) Assumption: false
(declare-const $1 Int)
(assert (and (< (- 128) $1) (< $1 127)))
(assert (not (= $1 44)))
; ($cast: int $1$ == 36(S32)) Assumption: false
(assert (not (= $1 36)))
; ($cast: int $1$ == 43(S32)) Assumption: false
(assert (not (= $1 43)))
; ($cast: int $1$ == 61(S32)) Assumption: false
(assert (not (= $1 61)))
; ($cast: int $1$ == 38(S32)) Assumption: false
(assert (not (= $1 38)))
; ($cast: int $1$ == 58(S32)) Assumption: false
(assert (not (= $1 58)))
; ($cast: int $1$ == 59(S32)) Assumption: false
(assert (not (= $1 59)))
