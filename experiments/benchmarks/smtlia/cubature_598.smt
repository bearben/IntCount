; output/00000950.smt: generated with canalyze.
; $16 Assumption: true
(declare-const $16 Int)
(assert (and (< (- 2147483648) $16) (< $16 2147483647)))
(assert (not (= $16 0)))
; (2(U64) < (((0(U64) + $cast: unsigned long (1(U32) + (2(U32) * (2(U32) * $3)))$) + $cast: unsigned long ((2(U32) * $3) * ($3 - 1(U32)))$) + $cast: unsigned long (1(U32) << $3)$)) Assumption: true
(declare-const $3 Int)
...
(assert (= $15 0))
; (1(U64) < (((0(U64) + $cast: unsigned long (1(U32) + (2(U32) * (2(U32) * $3)))$) + $cast: unsigned long ((2(U32) * $3) * ($3 - 1(U32)))$) + $cast: unsigned long (1(U32) << $3)$)) Assumption: true
; $14 Assumption: false
(declare-const $14 Int)
(assert (and (< (- 2147483648) $14) (< $14 2147483647)))
(assert (= $14 0))
; (0(U64) < (((0(U64) + $cast: unsigned long (1(U32) + (2(U32) * (2(U32) * $3)))$) + $cast: unsigned long ((2(U32) * $3) * ($3 - 1(U32)))$) + $cast: unsigned long (1(U32) << $3)$)) Assumption: true
; ($cast: unsigned int $1$ >= $3) Assumption: true
(declare-const $1 Int)
(assert (and (< (- 2147483648) $1) (< $1 2147483647)))
(assert (>= $1 $3))
; (1(U32) < ($3 - 1(U32))) Assumption: false
(assert (not (< 1 (- $3 1))))
; (0(U32) < ($3 - 1(U32))) Assumption: true
(assert (< 0 (- $3 1)))
; (($cast: long ((8(U64) * $cast: unsigned long $3$) * 3(U64))$ - (8(S64) * ((0(S64) + $cast: long $3$) + 1(S64)))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $3) 3) (* 8 (+ (+ 0 $3) 1))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $3$) * 3(U64))$ - (8(S64) * ((0(S64) + $cast: long $3$) + 0(S64)))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $3) 3) (* 8 (+ (+ 0 $3) 0))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $3$) * 3(U64))$ - (8(S64) * (0(S64) + $cast: long $3$))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $3) 3) (* 8 (+ 0 $3))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $3$) * 3(U64))$ - (8(S64) * ((0(S64) + $cast: long (2(U32) * $3)$) + 1(S64)))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $3) 3) (* 8 (+ (+ 0 (* 2 $3)) 1))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $3$) * 3(U64))$ - (8(S64) * ((0(S64) + $cast: long (2(U32) * $3)$) + 0(S64)))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $3) 3) (* 8 (+ (+ 0 (* 2 $3)) 0))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $3$) * 3(U64))$ - (8(S64) * (0(S64) + $cast: long (2(U32) * $3)$))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $3) 3) (* 8 (+ 0 (* 2 $3)))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $3$) * 3(U64))$ - 8(S64)) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $3) 3) 8) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $3$) * 3(U64))$ - 0(S64)) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $3) 3) 0) 8))
