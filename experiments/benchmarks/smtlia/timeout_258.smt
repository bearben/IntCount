; output/00000347.smt: generated with canalyze.
...
(assert (>= (- $26 0) 8))
; [sym$regval:24 [field: [field: [sym$regval:23 [field: [field: [sym$regval:5 [var: T]$]->expired]->tqh_first]$]->tqe]->tqe_next]$] != NULL Assumption: false
