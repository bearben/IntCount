; output/00000408.smt: generated with canalyze.
; (2(U32) < $14) Assumption: false
(declare-const $14 Int)
(assert (and (< 0 $14) (< $14 4294967295)))
(assert (not (< 2 $14)))
; (($cast: long $18$ - 16(S64)) >= 16(S64)) Assumption: true
(declare-const $18 Int)
(assert (and (< 0 $18) (< $18 18446744073709551615)))
(assert (>= (- $18 16) 16))
; (($cast: long $17$ - 16(S64)) >= 16(S64)) Assumption: true
(declare-const $17 Int)
(assert (and (< 0 $17) (< $17 18446744073709551615)))
(assert (>= (- $17 16) 16))
; (1(U32) < $14) Assumption: true
(assert (< 1 $14))
...
(assert (< 0 $14))
; $59 Assumption: false
(declare-const $59 Int)
(assert (and (< (- 2147483648) $59) (< $59 2147483647)))
(assert (= $59 0))
; (($cast: long $3$ - 480(S64)) >= 48(S64)) Assumption: true
(declare-const $3 Int)
(assert (and (< 0 $3) (< $3 18446744073709551615)))
(assert (>= (- $3 480) 48))
; (10(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(declare-const $1 Int)
...
(assert (not (= $31 0)))
; (($cast: long $3$ - 432(S64)) >= 48(S64)) Assumption: true
(assert (>= (- $3 432) 48))
; (9(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(assert (< 9 (- $1 1)))
; $43 Assumption: true
(declare-const $43 Int)
(assert (and (< (- 2147483648) $43) (< $43 2147483647)))
(assert (not (= $43 0)))
; (($cast: long $3$ - 192(S64)) >= 48(S64)) Assumption: true
(assert (>= (- $3 192) 48))
; (4(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(assert (< 4 (- $1 1)))
; $25 Assumption: true
(declare-const $25 Int)
(assert (and (< (- 2147483648) $25) (< $25 2147483647)))
(assert (not (= $25 0)))
; (($cast: long $3$ - 144(S64)) >= 48(S64)) Assumption: true
(assert (>= (- $3 144) 48))
; (3(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(assert (< 3 (- $1 1)))
; $37 Assumption: false
