; output/00001792.smt: generated with canalyze.
; (2048(U64) > ($cast: size_t (($1 - $4) / 1(S64))$ + $cast: size_t $6$)) Assumption: false
(declare-const $1 Int)
...
(assert (not (> 2048 (+ (/ (- $1 $4) 1) $6))))
; ((((53248(S64) - (4096(S64) * (0(S64) + $cast: long ($3 - 1(S32))$))) - 2048(S64)) - (1(S64) * (0(S64) + $cast: long ($cast: size_t $6$ + ((2048(U64) - $cast: size_t $6$) - 1(U64)))$))) >= 1(S64)) Assumption: true
(declare-const $3 Int)
(assert (and (< (- 2147483648) $3) (< $3 2147483647)))
(assert (>= (- (- (- 53248 (* 4096 (+ 0 (- $3 1)))) 2048) (* 1 (+ 0 (+ $6 (- (- 2048 $6) 1))))) 1))
; ((((53248(S64) - (4096(S64) * (0(S64) + $cast: long ($3 - 1(S32))$))) - 2048(S64)) - 0(S64)) >= 1(S64)) Assumption: true
(assert (>= (- (- (- 53248 (* 4096 (+ 0 (- $3 1)))) 2048) 0) 1))
; ($cast: size_t (($1 - $4) / 1(S64))$ < (2048(U64) - $cast: size_t $6$)) Assumption: false
(assert (not (< (/ (- $1 $4) 1) (- 2048 $6))))
