; output/00002059.smt: generated with canalyze.
; (2048(U64) > ($cast: size_t (($1 - $15) / 1(S64))$ + $cast: size_t $20$)) Assumption: false
(declare-const $1 Int)
...
(assert (not (> 2048 (+ (/ (- $1 $15) 1) $20))))
; ($cast: size_t $20$ < 2048(U64)) Assumption: false
(assert (not (< $20 2048)))
