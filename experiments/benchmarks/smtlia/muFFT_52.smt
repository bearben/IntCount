; output/00000071.smt: generated with canalyze.
; (($cast: long ($cast: unsigned long ($2 + 1(U32))$ * 24(U64))$ - (24(S64) * (0(S64) + $cast: long $2$))) >= 24(S64)) Assumption: true
(declare-const $2 Int)
(assert (and (< 0 $2) (< $2 4294967295)))
(assert (>= (- (* (+ $2 1) 24) (* 24 (+ 0 $2))) 24))
; $6 Assumption: true
(declare-const $6 Int)
(assert (and (< (- 9223372036854775808) $6) (< $6 9223372036854775807)))
(assert (not (= $6 0)))
; (($cast: unsigned long ($2 + 1(U32))$ * 24(U64)) > 0(U64)) Assumption: true
(assert (> (* (+ $2 1) 24) 0))
; ($9 >= 4(U32)) Assumption: false
(declare-const $9 Int)
(assert (and (< 0 $9) (< $9 4294967295)))
(assert (not (>= $9 4)))
; ($13 == 2(U32)) Assumption: true
