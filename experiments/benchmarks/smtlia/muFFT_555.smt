; output/00000596.smt: generated with canalyze.
; ($7 >= $8) Assumption: true
(declare-const $7 Int)
...
; (($5 & ((4(U32) & $not: (65535(U32) & $3)$) | ($3 & 201392128(U32)))) == $5) Assumption: false
(declare-const $5 Int)
...
(assert (not (>= $7 $12)))
; (($4 & ((4(U32) & $not: (65535(U32) & $3)$) | ($3 & 201392128(U32)))) == $4) Assumption: true
(declare-const $4 Int)
