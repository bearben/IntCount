; output/00001105.smt: generated with canalyze.
; $27 Assumption: true
(declare-const $27 Int)
(assert (and (< (- 2147483648) $27) (< $27 2147483647)))
(assert (not (= $27 0)))
; (21(U64) == $12) Assumption: true
(declare-const $12 Int)
(assert (and (< 0 $12) (< $12 18446744073709551615)))
(assert (= 21 $12))
; (20(U64) == $12) Assumption: false
(assert (not (= 20 $12)))
; (19(U64) == $12) Assumption: false
(assert (not (= 19 $12)))
; (18(U64) == $12) Assumption: false
(assert (not (= 18 $12)))
; (17(U64) == $12) Assumption: false
(assert (not (= 17 $12)))
; (16(U64) == $12) Assumption: false
(assert (not (= 16 $12)))
; (2(U32) < $cast: unsigned int (1(S32) << $16)$) Assumption: true
; (15(U64) == $12) Assumption: false
(assert (not (= 15 $12)))
; (14(U64) == $12) Assumption: false
(assert (not (= 14 $12)))
; (13(U64) == $12) Assumption: false
(assert (not (= 13 $12)))
; (12(U64) == $12) Assumption: false
(assert (not (= 12 $12)))
; (11(U64) == $12) Assumption: false
(assert (not (= 11 $12)))
; (10(U64) == $12) Assumption: false
(assert (not (= 10 $12)))
