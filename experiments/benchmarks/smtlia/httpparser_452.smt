; output/00000808.smt: generated with canalyze.
; ($cast: int $9$ == 58(S32)) Assumption: false
(declare-const $9 Int)
(assert (and (< (- 128) $9) (< $9 127)))
(assert (not (= $9 58)))
; ($cast: int $9$ == 95(S32)) Assumption: false
(assert (not (= $9 95)))
; ($cast: int $9$ == 45(S32)) Assumption: false
(assert (not (= $9 45)))
; ($cast: int $9$ == 46(S32)) Assumption: false
(assert (not (= $9 46)))
; ($cast: int $9$ <= 57(S32)) Assumption: false
(assert (not (<= $9 57)))
; ($cast: int $9$ >= 48(S32)) Assumption: true
(assert (>= $9 48))
; ($cast: int $cast: unsigned char ($cast: int $9$ | 32(S32))$$ >= 97(S32)) Assumption: false
...
; ($cast: int $8$ == 95(S32)) Assumption: true
(declare-const $8 Int)
(assert (and (< (- 128) $8) (< $8 127)))
(assert (= $8 95))
; ($cast: int $8$ == 45(S32)) Assumption: false
(assert (not (= $8 45)))
; ($cast: int $8$ == 46(S32)) Assumption: false
(assert (not (= $8 46)))
; ($cast: int $8$ <= 57(S32)) Assumption: false
(assert (not (<= $8 57)))
; ($cast: int $8$ >= 48(S32)) Assumption: true
(assert (>= $8 48))
; ($cast: int $cast: unsigned char ($cast: int $8$ | 32(S32))$$ >= 97(S32)) Assumption: false
...
(assert (< (+ (+ 0 $1) 1) (+ 0 (+ $1 $2))))
; ($cast: int $7$ == 45(S32)) Assumption: true
(declare-const $7 Int)
(assert (and (< (- 128) $7) (< $7 127)))
(assert (= $7 45))
; ($cast: int $7$ == 46(S32)) Assumption: false
(assert (not (= $7 46)))
