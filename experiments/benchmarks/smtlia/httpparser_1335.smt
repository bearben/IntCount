; output/00002877.smt: generated with canalyze.
; ($8 == 0(S32)) Assumption: true
(declare-const $8 Int)
(assert (and (< (- 2147483648) $8) (< $8 2147483647)))
(assert (= $8 0))
; ($cast: int $33$ == 58(S32)) Assumption: false
(declare-const $33 Int)
(assert (and (< (- 128) $33) (< $33 127)))
(assert (not (= $33 58)))
; ($cast: int $cast: unsigned char ($cast: int $33$ | 32(S32))$$ <= 122(S32)) Assumption: false
; ($cast: int $cast: unsigned char ($cast: int $33$ | 32(S32))$$ >= 97(S32)) Assumption: true
; ($cast: int $33$ == 10(S32)) Assumption: false
(assert (not (= $33 10)))
...
(assert (< 2 (+ 0 $11)))
; ($cast: int $cast: unsigned char ($cast: int $32$ | 32(S32))$$ <= 122(S32)) Assumption: true
