; output/00000298.smt: generated with canalyze.
...
(assert (>= (- $9 0) 24))
; [sym$regval:8 [field: [sym$regval:0 [var: plan]$]->c2r_resolve]$] != NULL Assumption: false
(declare-const $8 Int)
...
(assert (not (= $7 0)))
; ((($5 + 0(U32)) & 1(U32)) == 1(U32)) Assumption: false
