; output/00001025.smt: generated with canalyze.
; ($12 != 7(S32)) Assumption: true
(declare-const $12 Int)
(assert (and (< (- 2147483648) $12) (< $12 2147483647)))
(assert (not (= $12 7)))
; ($12 != 6(S32)) Assumption: true
(assert (not (= $12 6)))
; ($12 != 5(S32)) Assumption: true
(assert (not (= $12 5)))
; ($12 != 4(S32)) Assumption: true
(assert (not (= $12 4)))
; ($12 != 3(S32)) Assumption: true
(assert (not (= $12 3)))
