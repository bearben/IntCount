; output/00001783.smt: generated with canalyze.
...
; ((((53248(S64) - (4096(S64) * (0(S64) + $cast: long (($4 + 1(S32)) - 1(S32))$))) - 0(S64)) - (1(S64) * (0(S64) + $cast: long ($cast: size_t $7$ + ((2048(U64) - $cast: size_t $7$) - 1(U64)))$))) >= 1(S64)) Assumption: true
(declare-const $4 Int)
(assert (and (< (- 2147483648) $4) (< $4 2147483647)))
(assert (>= (- (- (- 53248 (* 4096 (+ 0 (- (+ $4 1) 1)))) 0) (* 1 (+ 0 (+ $7 (- (- 2048 $7) 1))))) 1))
; ((((53248(S64) - (4096(S64) * (0(S64) + $cast: long (($4 + 1(S32)) - 1(S32))$))) - 0(S64)) - 0(S64)) >= 1(S64)) Assumption: true
(assert (>= (- (- (- 53248 (* 4096 (+ 0 (- (+ $4 1) 1)))) 0) 0) 1))
