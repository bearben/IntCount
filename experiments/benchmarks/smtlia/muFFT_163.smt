; output/00000183.smt: generated with canalyze.
; ($7 >= $8) Assumption: true
(declare-const $7 Int)
...
(assert (>= $7 $8))
; (($6 & ((1(U32) & $not: (65535(U32) & $3)$) | ($3 & 201392128(U32)))) == $6) Assumption: true
(declare-const $6 Int)
(assert (and (< 0 $6) (< $6 4294967295)))
; (($5 & ((1(U32) & $not: (65535(U32) & $3)$) | ($3 & 201392128(U32)))) == $5) Assumption: false
(declare-const $5 Int)
(assert (and (< 0 $5) (< $5 4294967295)))
; (($4 & ((1(U32) & $not: (65535(U32) & $3)$) | ($3 & 201392128(U32)))) == $4) Assumption: false
(declare-const $4 Int)
