; output/00000191.smt: generated with canalyze.
; (($cast: int $2$ - 1(S32)) / 2(S32)) Assumption: false
(declare-const $2 Int)
(assert (and (< 0 $2) (< $2 18446744073709551615)))
(assert (= (/ (- $2 1) 2) 0))
; (($cast: long $5$ - (48(S64) * (0(S64) + $cast: long $cast: int $2$$))) >= 48(S64)) Assumption: true
(declare-const $5 Int)
...
(assert (= $11 0))
; (($cast: long $5$ - (48(S64) * (0(S64) + $cast: long (($cast: int $2$ - 1(S32)) / 2(S32))$))) >= 48(S64)) Assumption: true
(assert (>= (- $5 (* 48 (+ 0 (/ (- $2 1) 2)))) 48))
; $4 Assumption: true
(declare-const $4 Int)
