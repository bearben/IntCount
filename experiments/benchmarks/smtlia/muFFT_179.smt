; output/00000199.smt: generated with canalyze.
...
(assert (>= $7 $10))
; (($5 & ((2(U32) & $not: (65535(U32) & $3)$) | ($3 & 201392128(U32)))) == $5) Assumption: true
(declare-const $5 Int)
(assert (and (< 0 $5) (< $5 4294967295)))
; (($4 & ((2(U32) & $not: (65535(U32) & $3)$) | ($3 & 201392128(U32)))) == $4) Assumption: false
(declare-const $4 Int)
