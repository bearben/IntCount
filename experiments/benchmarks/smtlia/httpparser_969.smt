; output/00001786.smt: generated with canalyze.
...
(assert (> 2048 (+ (/ (- $1 $5) 1) $7)))
; ((((53248(S64) - (4096(S64) * (0(S64) + $cast: long (($4 + 1(S32)) - 1(S32))$))) - 0(S64)) - (1(S64) * (0(S64) + $cast: long ($cast: size_t $7$ + $cast: size_t (($1 - $5) / 1(S64))$)$))) >= 1(S64)) Assumption: true
(declare-const $4 Int)
(assert (and (< (- 2147483648) $4) (< $4 2147483647)))
(assert (>= (- (- (- 53248 (* 4096 (+ 0 (- (+ $4 1) 1)))) 0) (* 1 (+ 0 (+ $7 (/ (- $1 $5) 1))))) 1))
