; output/00004018.smt: generated with canalyze.
; ($10 == 0(S32)) Assumption: true
(declare-const $10 Int)
(assert (and (< (- 2147483648) $10) (< $10 2147483647)))
(assert (= $10 0))
; ($cast: int $35$ == 10(S32)) Assumption: true
(declare-const $35 Int)
(assert (and (< (- 128) $35) (< $35 127)))
(assert (= $35 10))
; ($cast: int $35$ == 13(S32)) Assumption: false
(assert (not (= $35 13)))
; ($cast: int $35$ == 32(S32)) Assumption: false
(assert (not (= $35 32)))
; (($cast: long $32$ - 2(S64)) >= 1(S64)) Assumption: true
(declare-const $32 Int)
(assert (and (< 0 $32) (< $32 18446744073709551615)))
(assert (>= (- $32 2) 1))
; (2(S64) < (0(S64) + $cast: long $cast: size_t $13$$)) Assumption: true
(declare-const $13 Int)
(assert (and (< 0 $13) (< $13 18446744073709551615)))
(assert (< 2 (+ 0 $13)))
; (($cast: unsigned int $36$ & $cast: unsigned int (1(S32) << ($cast: unsigned int $cast: unsigned char $34$$ & 7(U32)))$) == 0(U32)) Assumption: false
; ((32(S64) - (1(S64) * (0(S64) + $cast: long ($cast: unsigned int $cast: unsigned char $34$$ >> 3(S32))$))) >= 1(S64)) Assumption: true
...
(assert (< 1 (+ 0 $13)))
; ($cast: int $cast: const char $33$$ == 42(S32)) Assumption: true
