...
(assert (not (= $7 0)))
; (((4096(S64) - (1024(S64) * (0(S64) + $cast: long ($4 + 1(U32))$))) - 16(S64)) >= 16(S64)) Assumption: true
(declare-const $4 Int)
(assert (and (< 0 $4) (< $4 4294967295)))
(assert (>= (- (- 4096 (* 1024 (+ 0 (+ $4 1)))) 16) 16))
; $6 Assumption: false
(declare-const $6 Int)
(assert (and (< (- 9223372036854775808) $6) (< $6 9223372036854775807)))
(assert (= $6 0))
; (((4096(S64) - (1024(S64) * (0(S64) + $cast: long ($4 + 1(U32))$))) - 0(S64)) >= 16(S64)) Assumption: true
(assert (>= (- (- 4096 (* 1024 (+ 0 (+ $4 1)))) 0) 16))
; $5 Assumption: true
(declare-const $5 Int)
(assert (and (< (- 9223372036854775808) $5) (< $5 9223372036854775807)))
(assert (not (= $5 0)))
; ($cast: unsigned long ($4 + 1(U32))$ < 4(U64)) Assumption: true
(assert (< (+ $4 1) 4))
