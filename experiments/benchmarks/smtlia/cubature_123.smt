...
(assert (= $59 0))
; (($cast: long $3$ - 384(S64)) >= 48(S64)) Assumption: true
(declare-const $3 Int)
(assert (and (< 0 $3) (< $3 18446744073709551615)))
(assert (>= (- $3 384) 48))
; (8(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(declare-const $1 Int)
...
(assert (not (= $31 0)))
; (($cast: long $3$ - 336(S64)) >= 48(S64)) Assumption: true
(assert (>= (- $3 336) 48))
; (7(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(assert (< 7 (- $1 1)))
; $43 Assumption: false
