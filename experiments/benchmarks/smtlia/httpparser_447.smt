; output/00000803.smt: generated with canalyze.
; ((((0(S64) + $cast: long $cast: int $1$$) + 1(S64)) + 1(S64)) < (0(S64) + $cast: long $cast: size_t ($cast: int $1$ + $cast: int $2$)$$)) Assumption: false
(declare-const $1 Int)
(assert (and (< 0 $1) (< $1 65535)))
(declare-const $2 Int)
(assert (and (< 0 $2) (< $2 65535)))
(assert (not (< (+ (+ (+ 0 $1) 1) 1) (+ 0 (+ $1 $2)))))
; ($cast: int $8$ == 58(S32)) Assumption: true
(declare-const $8 Int)
(assert (and (< (- 128) $8) (< $8 127)))
(assert (= $8 58))
; ($cast: int $8$ == 95(S32)) Assumption: false
(assert (not (= $8 95)))
