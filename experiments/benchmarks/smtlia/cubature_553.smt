; output/00000890.smt: generated with canalyze.
; $15 Assumption: true
(declare-const $15 Int)
(assert (and (< (- 2147483648) $15) (< $15 2147483647)))
(assert (not (= $15 0)))
; ($cast: unsigned int $1$ >= $1) Assumption: true
(declare-const $1 Int)
(assert (and (< (- 2147483648) $1) (< $1 2147483647)))
(assert (>= $1 $1))
; (1(U32) < ($1 - 1(U32))) Assumption: false
(assert (not (< 1 (- $1 1))))
; (0(U32) < ($1 - 1(U32))) Assumption: true
(assert (< 0 (- $1 1)))
; (($cast: long ((8(U64) * $cast: unsigned long $1$) * 3(U64))$ - (8(S64) * ((0(S64) + $cast: long $1$) + 1(S64)))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $1) 3) (* 8 (+ (+ 0 $1) 1))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $1$) * 3(U64))$ - (8(S64) * ((0(S64) + $cast: long $1$) + 0(S64)))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $1) 3) (* 8 (+ (+ 0 $1) 0))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $1$) * 3(U64))$ - (8(S64) * (0(S64) + $cast: long $1$))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $1) 3) (* 8 (+ 0 $1))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $1$) * 3(U64))$ - (8(S64) * ((0(S64) + $cast: long (2(U32) * $1)$) + 1(S64)))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $1) 3) (* 8 (+ (+ 0 (* 2 $1)) 1))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $1$) * 3(U64))$ - (8(S64) * ((0(S64) + $cast: long (2(U32) * $1)$) + 0(S64)))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $1) 3) (* 8 (+ (+ 0 (* 2 $1)) 0))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $1$) * 3(U64))$ - (8(S64) * (0(S64) + $cast: long (2(U32) * $1)$))) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $1) 3) (* 8 (+ 0 (* 2 $1)))) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $1$) * 3(U64))$ - 8(S64)) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $1) 3) 8) 8))
; (($cast: long ((8(U64) * $cast: unsigned long $1$) * 3(U64))$ - 0(S64)) >= 8(S64)) Assumption: true
(assert (>= (- (* (* 8 $1) 3) 0) 8))
...
(assert (> (* 16 $0) 0))
; ($cast: unsigned int $13$ > 4(U32)) Assumption: false
(declare-const $13 Int)
(assert (and (< 0 $13) (< $13 4294967295)))
(assert (not (> $13 4)))
; ($cast: unsigned int $13$ < 0(U32)) Assumption: false
(assert (not (< $13 0)))
