; output/00002064.smt: generated with canalyze.
; (2048(U64) > ($cast: size_t (($1 - $15) / 1(S64))$ + $cast: size_t $20$)) Assumption: true
(declare-const $1 Int)
...
(assert (> 2048 (+ (/ (- $1 $15) 1) $20)))
; ((((53248(S64) - (4096(S64) * (0(S64) + $cast: long ($19 - 1(S32))$))) - 2048(S64)) - (1(S64) * (0(S64) + $cast: long ($cast: size_t $20$ + $cast: size_t (($1 - $15) / 1(S64))$)$))) >= 1(S64)) Assumption: true
(declare-const $19 Int)
(assert (and (< (- 2147483648) $19) (< $19 2147483647)))
(assert (>= (- (- (- 53248 (* 4096 (+ 0 (- $19 1)))) 2048) (* 1 (+ 0 (+ $20 (/ (- $1 $15) 1))))) 1))
; ((((53248(S64) - (4096(S64) * (0(S64) + $cast: long ($19 - 1(S32))$))) - 2048(S64)) - 0(S64)) >= 1(S64)) Assumption: true
(assert (>= (- (- (- 53248 (* 4096 (+ 0 (- $19 1)))) 2048) 0) 1))
; ($cast: size_t (($1 - $15) / 1(S64))$ < (2048(U64) - $cast: size_t $20$)) Assumption: true
(assert (< (/ (- $1 $15) 1) (- 2048 $20)))
; ($cast: size_t $20$ < 2048(U64)) Assumption: true
(assert (< $20 2048))
; [sym$FuncSymbol:1 memchr$] == NULL Assumption: false
(assert (not (= $1 0)))
; $15 Assumption: true
(assert (not (= $15 0)))
; (((53248(S64) - (4096(S64) * (0(S64) + $cast: long ($19 - 1(S32))$))) - 0(S64)) >= 2048(S64)) Assumption: true
(assert (>= (- (- 53248 (* 4096 (+ 0 (- $19 1)))) 0) 2048))
