...
(assert (not (= $11 0)))
; (((4096(S64) - (1024(S64) * (0(S64) + $cast: long $4$))) - (16(S64) * (0(S64) + $cast: long (($3 + 1(U32)) + 1(U32))$))) >= 16(S64)) Assumption: true
(declare-const $4 Int)
(assert (and (< 0 $4) (< $4 4294967295)))
(declare-const $3 Int)
(assert (and (< 0 $3) (< $3 4294967295)))
(assert (>= (- (- 4096 (* 1024 (+ 0 $4))) (* 16 (+ 0 (+ (+ $3 1) 1)))) 16))
; ($cast: unsigned long (($3 + 1(U32)) + 1(U32))$ < 64(U64)) Assumption: true
(assert (< (+ (+ $3 1) 1) 64))
; $10 Assumption: false
