; output/00000034.smt: generated with canalyze.
; $5 Assumption: true
(declare-const $5 Int)
...
(assert (not (> $3 $4)))
; [sym$regval:16 [field: [sym$regval:2 [field: [sym$regval:1 [var: to]$]->pending]$]->tqh_first]$] == NULL Assumption: false
...
(assert (not (= $12 0)))
; [sym$regval:12 [field: [field: [sym$regval:1 [var: to]$]->tqe]->tqe_next]$] != NULL Assumption: true
(assert (not (= $12 0)))
; $2 Assumption: true
(declare-const $2 Int)
