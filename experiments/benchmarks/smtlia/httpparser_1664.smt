; output/00003899.smt: generated with canalyze.
; (2(S64) != (0(S64) + $cast: long $cast: size_t $2$$)) Assumption: false
(declare-const $2 Int)
(assert (and (< 0 $2) (< $2 18446744073709551615)))
(assert (not (not (= 2 (+ 0 $2)))))
; ((983296(S32) | $cast: int $13$) == 1704271(S32)) Assumption: true
; ($cast: int $13$ == 45(S32)) Assumption: true
(declare-const $13 Int)
(assert (and (< (- 128) $13) (< $13 127)))
(assert (= $13 45))
; ($cast: int $13$ >= 65(S32)) Assumption: false
(assert (not (>= $13 65)))
