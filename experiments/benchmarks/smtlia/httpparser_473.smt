; output/00000840.smt: generated with canalyze.
; ($cast: int $7$ == 58(S32)) Assumption: false
(declare-const $7 Int)
(assert (and (< (- 128) $7) (< $7 127)))
(assert (not (= $7 58)))
; ($cast: int $cast: unsigned char ($cast: int $7$ | 32(S32))$$ <= 122(S32)) Assumption: false
; ($cast: int $cast: unsigned char ($cast: int $7$ | 32(S32))$$ >= 97(S32)) Assumption: true
; ($cast: int $7$ == 10(S32)) Assumption: false
(assert (not (= $7 10)))
; ($cast: int $7$ == 13(S32)) Assumption: false
(assert (not (= $7 13)))
