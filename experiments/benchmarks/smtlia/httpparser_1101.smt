; output/00002088.smt: generated with canalyze.
; ($cast: int $22$ == 62(S32)) Assumption: false
...
; ((2048(S64) - (1(S64) * (0(S64) + $cast: long ($cast: size_t $19$ + $cast: size_t (($1 - $15) / 1(S64))$)$))) >= 1(S64)) Assumption: true
(assert (>= (- 2048 (* 1 (+ 0 (+ $19 (/ (- $1 $15) 1))))) 1))
; ($cast: size_t (($1 - $15) / 1(S64))$ < (2048(U64) - $cast: size_t $19$)) Assumption: true
(assert (< (/ (- $1 $15) 1) (- 2048 $19)))
; ($cast: size_t $19$ < 2048(U64)) Assumption: true
(assert (< $19 2048))
