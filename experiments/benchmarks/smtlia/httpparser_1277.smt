; output/00002805.smt: generated with canalyze.
...
; (($cast: long $21$ - (1(S64) * ((0(S64) + $cast: long $16$) + $cast: long $14$))) >= 1(S64)) Assumption: true
...
(assert (>= (- $21 (* 1 (+ (+ 0 $16) $14))) 1))
; (($cast: long $21$ - (1(S64) * (((0(S64) + $cast: long $16$) + $cast: long $14$) + 0(S64)))) >= 1(S64)) Assumption: true
(assert (>= (- $21 (* 1 (+ (+ (+ 0 $16) $14) 0))) 1))
; ($14 > 0(U64)) Assumption: true
(assert (> $14 0))
; $13 Assumption: true
(declare-const $13 Int)
(assert (and (< (- 9223372036854775808) $13) (< $13 9223372036854775807)))
(assert (not (= $13 0)))
; ($12 > 0(U64)) Assumption: true
