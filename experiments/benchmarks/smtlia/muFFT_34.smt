; output/00000043.smt: generated with canalyze.
; (1(U32) < ($6 >> 2(S32))) Assumption: false
...
(assert (>= (- $9 8) 8))
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long (1(U32) + (3(U32) * ($5 * ($6 >> 2(S32)))))$))) >= 8(S64)) Assumption: true
(declare-const $7 Int)
(assert (and (< 0 $7) (< $7 18446744073709551615)))
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long (1(U32) + (2(U32) * ($5 * ($6 >> 2(S32)))))$))) >= 8(S64)) Assumption: true
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long (1(U32) + ($5 * ($6 >> 2(S32))))$))) >= 8(S64)) Assumption: true
...
(assert (not (= $2 0)))
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long (0(U32) + (3(U32) * ($5 * ($6 >> 2(S32)))))$))) >= 8(S64)) Assumption: true
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long (0(U32) + (2(U32) * ($5 * ($6 >> 2(S32)))))$))) >= 8(S64)) Assumption: true
; (($cast: long $7$ - (8(S64) * (0(S64) + $cast: long (0(U32) + ($5 * ($6 >> 2(S32))))$))) >= 8(S64)) Assumption: true
; (($cast: long $7$ - 0(S64)) >= 8(S64)) Assumption: true
(assert (>= (- $7 0) 8))
; (0(U32) < $4) Assumption: true
(assert (< 0 $4))
; (0(U32) < ($6 >> 2(S32))) Assumption: true
(check-sat)
