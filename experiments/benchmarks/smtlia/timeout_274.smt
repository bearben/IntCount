...
; [sym$regval:7 [field: [sym$regval:2 [field: [sym$regval:0 [var: to]$]->pending]$]->tqh_first]$] == NULL Assumption: true
(declare-const $7 Int)
...
(assert (>= (- $5 0) 8))
; [sym$regval:3 [field: [field: [sym$regval:0 [var: to]$]->tqe]->tqe_next]$] != NULL Assumption: false
(declare-const $3 Int)
