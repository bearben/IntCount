; output/00003888.smt: generated with canalyze.
; ($cast: unsigned int $cast: enum http_errno $12$$ != 0(U32)) Assumption: true
(declare-const $12 Int)
(assert (and (< 0 $12) (< $12 4294967295)))
(assert (not (= $12 0)))
; (0(S32) != $10) Assumption: false
(declare-const $10 Int)
(assert (and (< (- 2147483648) $10) (< $10 2147483647)))
(assert (not (not (= 0 $10))))
; [sym$regval:9 [field: [var: settings_connect]->on_message_begin]$] == NULL Assumption: false
(declare-const $9 Int)
