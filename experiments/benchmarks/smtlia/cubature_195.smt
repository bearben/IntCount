; output/00000504.smt: generated with canalyze.
...
(assert (= $59 0))
; (($cast: long $3$ - 672(S64)) >= 48(S64)) Assumption: true
(declare-const $3 Int)
(assert (and (< 0 $3) (< $3 18446744073709551615)))
(assert (>= (- $3 672) 48))
; (14(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(declare-const $1 Int)
...
(assert (not (= $31 0)))
; (($cast: long $3$ - 624(S64)) >= 48(S64)) Assumption: true
(assert (>= (- $3 624) 48))
; (13(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(assert (< 13 (- $1 1)))
; $43 Assumption: true
