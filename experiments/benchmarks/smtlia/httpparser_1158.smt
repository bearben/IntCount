; output/00002299.smt: generated with canalyze.
; ($cast: unsigned long long $9$ != 18446744073709551615(U64)) Assumption: true
(declare-const $9 Int)
(assert (and (< 0 $9) (< $9 18446744073709551615)))
(assert (not (= $9 18446744073709551615)))
; ($cast: int $7$ & 1(S32)) Assumption: false
; ($cast: int $7$ & 64(S32)) Assumption: false
