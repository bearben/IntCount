; output/00002893.smt: generated with canalyze.
; ($8 == 0(S32)) Assumption: false
(declare-const $8 Int)
(assert (and (< (- 2147483648) $8) (< $8 2147483647)))
(assert (not (= $8 0)))
; (2(S64) < (0(S64) + $cast: long $cast: size_t $11$$)) Assumption: false
(declare-const $11 Int)
(assert (and (< 0 $11) (< $11 18446744073709551615)))
(assert (not (< 2 (+ 0 $11))))
; (($cast: unsigned int $34$ & $cast: unsigned int (1(S32) << ($cast: unsigned int $cast: unsigned char $32$$ & 7(U32)))$) == 0(U32)) Assumption: false
; ((32(S64) - (1(S64) * (0(S64) + $cast: long ($cast: unsigned int $cast: unsigned char $32$$ >> 3(S32))$))) >= 1(S64)) Assumption: true
...
(assert (< 1 (+ 0 $11)))
; ($cast: int $cast: const char $31$$ == 47(S32)) Assumption: true
