; output/00002046.smt: generated with canalyze.
...
; ((((53248(S64) - (4096(S64) * (0(S64) + $cast: long ($20 - 1(S32))$))) - 0(S64)) - (1(S64) * (0(S64) + $cast: long ($cast: size_t $21$ + $cast: size_t (($1 - $15) / 1(S64))$)$))) >= 1(S64)) Assumption: true
(declare-const $20 Int)
(assert (and (< (- 2147483648) $20) (< $20 2147483647)))
(assert (>= (- (- (- 53248 (* 4096 (+ 0 (- $20 1)))) 0) (* 1 (+ 0 (+ $21 (/ (- $1 $15) 1))))) 1))
; ((((53248(S64) - (4096(S64) * (0(S64) + $cast: long ($20 - 1(S32))$))) - 0(S64)) - 0(S64)) >= 1(S64)) Assumption: true
(assert (>= (- (- (- 53248 (* 4096 (+ 0 (- $20 1)))) 0) 0) 1))
