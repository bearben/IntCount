; output/00000429.smt: generated with canalyze.
...
(assert (= $59 0))
; (($cast: long $3$ - 576(S64)) >= 48(S64)) Assumption: true
(declare-const $3 Int)
(assert (and (< 0 $3) (< $3 18446744073709551615)))
(assert (>= (- $3 576) 48))
; (12(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(declare-const $1 Int)
...
(assert (not (= $31 0)))
; (($cast: long $3$ - 528(S64)) >= 48(S64)) Assumption: true
(assert (>= (- $3 528) 48))
; (11(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(assert (< 11 (- $1 1)))
; $43 Assumption: false
(declare-const $43 Int)
(assert (and (< (- 2147483648) $43) (< $43 2147483647)))
(assert (= $43 0))
; (($cast: long $3$ - 288(S64)) >= 48(S64)) Assumption: true
(assert (>= (- $3 288) 48))
; (6(S32) < $cast: int ($1 - 1(U64))$) Assumption: true
(assert (< 6 (- $1 1)))
; $25 Assumption: false
